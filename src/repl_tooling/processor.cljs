(ns repl-tooling.processor
 (:require [clojure.string :as s]
           ; [com.rpl.specter :as sp]
           [repl-tooling.prettify-exception :as p-exc]
           ;[errors.utils :as u]
           [repl-tooling.dictionaries :as d]
...
;; modified process-message function that takes a string representing a type of error.
;; Used for testing to see what modify-message in editor_helpers.cljs was actually
;; handing this function.  As it turns out, it wasn't a string.
;; See STRINGSARENOTSTRINGS.txt for findings.
(defn str-process-message
   "Takes a type and a message and returns a string based on the match found in error
   dictionary"
   [t m]
   (p-exc/str-process-errors t m))
