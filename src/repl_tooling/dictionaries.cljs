...
;; Original babel type-dictionary
...
;; Try to find super-classes and see if we can get the interfaces a class implements
;; https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Class.html
#_(def general-types [[java.lang.Number "a number"]
...
;; keyword general-types
(def key-general-types [[:java.lang.Number "a number"]
                    [:clojure.lang.IPersistentVector "a vector"]
                    [:clojure.lang.IPersistentList "a list"]
                    [:clojure.lang.IPersistentSet "a set"]
                    [:clojure.lang.IPersistentMap "a map"]
...
;; String general-types
(def str-general-types [["java.lang.Number" "a number"]
                    ["clojure.lang.IPersistentVector" "a vector"]
                    ["clojure.lang.IPersistentList" "a list"]
                    ["clojure.lang.IPersistentSet" "a set"]
                    ["clojure.lang.IPersistentMap" "a map"]
...
(defn type-and-val
  ...
  (cond (nil? s) ["" "nil"]
        ...
        :else (let [t (get-dictionary-type s)]
                   (cond
                         #_(is-specced-fn? s) #_["a function " (str (specced-fn-name s))]
...
#_(def class-lookup [[java.lang.Number "a number"]
                   [java.lang.String "a string"]
                   [java.lang.Character "a character"]])

;; String class-lookup
(def str-class-lookup [["java.lang.Number" "a number"]
                   ["java.lang.String" "a string"]
                   ["java.lang.Character" "a character"]])

;; keyword class-lookup
(def key-class-lookup [[:java.lang.Number "a number"]
                   [:java.lang.String "a string"]
                   [:java.lang.Character "a character"]])
