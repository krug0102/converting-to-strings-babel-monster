...
var len__4829__auto___151872 = arguments.length;
var i__4830__auto___151873 = (0);
while(true){
if((i__4830__auto___151873 < len__4829__auto___151872)){
args__4835__auto__.push((arguments[i__4830__auto___151873]));

var G__151874 = (i__4830__auto___151873 + (1));
i__4830__auto___151873 = G__151874;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__151868){
var vec__151869 = p__151868;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151869,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__151865_SHARP_){
var and__4221__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__151865_SHARP_) : allowed_QMARK_.call(null,p1__151865_SHARP_)));
if(and__4221__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__151865_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq151866){
var G__151867 = cljs.core.first(seq151866);
var seq151866__$1 = cljs.core.next(seq151866);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__151867,seq151866__$1);
}));
