...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k151615,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__151624 = k151615;
var G__151624__$1 = (((G__151624 instanceof cljs.core.Keyword))?G__151624.fqn:null);
switch (G__151624__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k151615,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__151628){
var vec__151629 = p__151628;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151629,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151629,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__151614){
var self__ = this;
var G__151614__$1 = this;
return (new cljs.core.RecordIter((0),G__151614__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this151616,other151617){
var self__ = this;
var this151616__$1 = this;
return (((!((other151617 == null)))) && ((((this151616__$1.constructor === other151617.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151616__$1.tag,other151617.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151616__$1.prefix,other151617.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151616__$1.sym,other151617.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151616__$1.children,other151617.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151616__$1.__extmap,other151617.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k151615){
var self__ = this;
var this__4479__auto____$1 = this;
var G__151658 = k151615;
var G__151658__$1 = (((G__151658 instanceof cljs.core.Keyword))?G__151658.fqn:null);
switch (G__151658__$1) {
case "tag":
case "prefix":
case "sym":
case "children":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k151615);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__151614){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__151659 = cljs.core.keyword_identical_QMARK_;
var expr__151660 = k__4481__auto__;
if(cljs.core.truth_((pred__151659.cljs$core$IFn$_invoke$arity$2 ? pred__151659.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__151660) : pred__151659.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__151660)))){
return (new rewrite_clj.node.quote.QuoteNode(G__151614,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__151659.cljs$core$IFn$_invoke$arity$2 ? pred__151659.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__151660) : pred__151659.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__151660)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__151614,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__151659.cljs$core$IFn$_invoke$arity$2 ? pred__151659.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__151660) : pred__151659.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__151660)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__151614,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__151659.cljs$core$IFn$_invoke$arity$2 ? pred__151659.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__151660) : pred__151659.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__151660)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__151614,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__151614),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__151614){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__151614,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__151620){
var extmap__4512__auto__ = (function (){var G__151666 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__151620,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__151620)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__151666);
} else {
return G__151666;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__151620),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__151620),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__151620),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__151620),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var G__151677 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__151677;
continue;
}
break;
...
var G__151684 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__151684;
continue;
}
break;
...
var G__151688 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__151688;
continue;
}
break;
...
var G__151689 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__151689;
continue;
}
break;
