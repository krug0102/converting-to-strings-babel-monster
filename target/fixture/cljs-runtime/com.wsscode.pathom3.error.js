...
com.wsscode.pathom3.error.attribute_node_error = (function com$wsscode$pathom3$error$attribute_node_error(p__158958,node_id){
var map__158959 = p__158958;
var map__158959__$1 = cljs.core.__destructure_map(map__158959);
var graph = map__158959__$1;
var node_run_stats = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__158959__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.runner","node-run-stats","com.wsscode.pathom3.connect.runner/node-run-stats",-2036346899));
var map__158960 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(node_run_stats,node_id);
var map__158960__$1 = cljs.core.__destructure_map(map__158960);
var node_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__158960__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.runner","node-error","com.wsscode.pathom3.connect.runner/node-error",890120380));
var node_run_finish_ms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__158960__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.runner","node-run-finish-ms","com.wsscode.pathom3.connect.runner/node-run-finish-ms",1292429944));
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__158963 = temp__5751__auto__;
var node_id_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__158963,(0),null);
var error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__158963,(1),null);
...
var map__158968 = new cljs.core.Keyword("com.wsscode.pathom3.connect.runner","run-stats","com.wsscode.pathom3.connect.runner/run-stats",1718909061).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(response));
var map__158968__$1 = cljs.core.__destructure_map(map__158968);
var run_stats = map__158968__$1;
var index_ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__158968__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.planner","index-ast","com.wsscode.pathom3.connect.planner/index-ast",905845713));
var index_attrs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__158968__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.planner","index-attrs","com.wsscode.pathom3.connect.planner/index-attrs",-2110590142));
...
var G__158973 = response;
var G__158973__$1 = (((G__158973 == null))?null:cljs.core.meta(G__158973));
if((G__158973__$1 == null)){
return null;
} else {
return cljs.core.contains_QMARK_(G__158973__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.runner","run-stats","com.wsscode.pathom3.connect.runner/run-stats",1718909061));
}
});
