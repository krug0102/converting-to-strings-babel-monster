...
repl_tooling.editor_integration.embedded_clojurescript.warn_html = (function repl_tooling$editor_integration$embedded_clojurescript$warn_html(title,p__140277){
var map__140278 = p__140277;
var map__140278__$1 = cljs.core.__destructure_map(map__140278);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140278__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140278__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var msg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140278__$1,new cljs.core.Keyword(null,"msg","msg",-1386103444));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140278__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var warnings = cljs.core.vec(cljs.core.cons(new cljs.core.Keyword(null,"<>","<>",1280186386),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__140281_SHARP_){
return repl_tooling.editor_integration.embedded_clojurescript.warn_html(txt,p1__140281_SHARP_);
...
var map__140294 = opts;
var map__140294__$1 = cljs.core.__destructure_map(map__140294);
var notify = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140294__$1,new cljs.core.Keyword(null,"notify","notify",-1256867814));
var on_result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140294__$1,new cljs.core.Keyword(null,"on-result","on-result",-1034982142));
var on_stdout = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140294__$1,new cljs.core.Keyword(null,"on-stdout","on-stdout",1480958368));
var map__140295 = new cljs.core.Keyword("repl","info","repl/info",-345199547).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state));
var map__140295__$1 = cljs.core.__destructure_map(map__140295);
var host = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140295__$1,new cljs.core.Keyword(null,"host","host",-1558485167));
var port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140295__$1,new cljs.core.Keyword(null,"port","port",1534937262));
...
var after_connect = (function (p1__140288_SHARP_){
var temp__5751__auto__ = new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(p1__140288_SHARP_);
...
repl_tooling.editor_integration.embedded_clojurescript.save_repl_info_BANG_(state,target,p1__140288_SHARP_);
...
repl_tooling.editor_integration.embedded_clojurescript.choose_id_BANG_ = (function repl_tooling$editor_integration$embedded_clojurescript$choose_id_BANG_(state,p__140304,commands,use_new_QMARK_){
var map__140305 = p__140304;
var map__140305__$1 = cljs.core.__destructure_map(map__140305);
var opts = map__140305__$1;
var prompt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140305__$1,new cljs.core.Keyword(null,"prompt","prompt",-78109487));
return (function (){var G__140306 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Multiple Shadow-CLJS targets",new cljs.core.Keyword(null,"message","message",-406056002),"Choose the build target that you want to connect",new cljs.core.Keyword(null,"arguments","arguments",-1182834456),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (id){
...
return (prompt.cljs$core$IFn$_invoke$arity$1 ? prompt.cljs$core$IFn$_invoke$arity$1(G__140306) : prompt.call(null,G__140306));
})().then((function (p1__140302_SHARP_){
return repl_tooling.editor_integration.embedded_clojurescript.connect_and_update_state_BANG_(state,opts,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__140302_SHARP_),(cljs.core.truth_(use_new_QMARK_)?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(commands,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__140302_SHARP_))));
}));
});
repl_tooling.editor_integration.embedded_clojurescript.connect_embedded = (function repl_tooling$editor_integration$embedded_clojurescript$connect_embedded(state,p__140311,use_new_QMARK_){
var map__140312 = p__140311;
var map__140312__$1 = cljs.core.__destructure_map(map__140312);
var opts = map__140312__$1;
var get_config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140312__$1,new cljs.core.Keyword(null,"get-config","get-config",1800808901));
var notify = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140312__$1,new cljs.core.Keyword(null,"notify","notify",-1256867814));
...
var G__140313 = cljs.core.count(commands);
switch (G__140313) {
case (0):
...
repl_tooling.editor_integration.embedded_clojurescript.connect_BANG_ = (function repl_tooling$editor_integration$embedded_clojurescript$connect_BANG_(state,p__140321,use_new_QMARK_){
var map__140322 = p__140321;
var map__140322__$1 = cljs.core.__destructure_map(map__140322);
var opts = map__140322__$1;
var notify = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__140322__$1,new cljs.core.Keyword(null,"notify","notify",-1256867814));
