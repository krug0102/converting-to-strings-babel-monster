...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(repl_tooling.editor_integration.renderer.interactive.edn_QMARK_,cljs.core.second),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51252_SHARP_){
var norm = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.replace(p1__51252_SHARP_,/[A-Z]/,(function (r){
return ["-",clojure.string.lower_case(r)].join('');
})));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [norm,(obj[p1__51252_SHARP_])], null);
...
var norm = (function (p1__51253_SHARP_){
if(((cljs.core.tagged_literal_QMARK_(p1__51253_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__51253_SHARP_.tag,new cljs.core.Symbol("tooling","eval","tooling/eval",2084422636,null))))){
return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__51253_SHARP_.form], 0));
} else {
return ["'",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__51253_SHARP_], 0))].join('');
}
});
...
var res = (function (){var G__51254 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("text","contents","text/contents",-1566533716),code], null);
var G__51255 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("repl","result","repl/result",1421065572)], null);
return (eql.cljs$core$IFn$_invoke$arity$2 ? eql.cljs$core$IFn$_invoke$arity$2(G__51254,G__51255) : eql.call(null,G__51254,G__51255));
})();
...
return (function() { 
var G__51282__delegate = function (args){
...
while (G__51283__i < G__51283__a.length) {G__51283__a[G__51283__i] = arguments[G__51283__i + 0]; ++G__51283__i;}
  args = new cljs.core.IndexedSeq(G__51283__a,0,null);
} 
return G__51282__delegate.call(this,args);};
G__51282.cljs$lang$maxFixedArity = 0;
G__51282.cljs$lang$applyTo = (function (arglist__51284){
var args = cljs.core.seq(arglist__51284);
return G__51282__delegate(args);
});
...
var binds__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(binds,new cljs.core.Symbol(null,"?state","?state",-1752482484,null),cljs.core.deref(state),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Symbol(null,"?state-atom","?state-atom",-1559113913,null),state,new cljs.core.Symbol(null,"eql","eql",-1239543386,null),eql,new cljs.core.Symbol(null,"eval","eval",536963622,null),(function (p1__51256_SHARP_){
return cljs.core.tagged_literal(new cljs.core.Symbol("tooling","eval","tooling/eval",2084422636,null),p1__51256_SHARP_);
})], 0));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(binds__$1,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__51257){
var vec__51258 = p__51257;
var f_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51258,(0),null);
var f_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51258,(1),null);
...
var cached_result = (function (){var G__51261 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editor","data","editor/data",-1539989548),new cljs.core.Keyword("config","repl-kind","config/repl-kind",1937588875),new cljs.core.Keyword("config","eval-as","config/eval-as",-937334597),new cljs.core.Keyword("config","project-paths","config/project-paths",1302768596),new cljs.core.Keyword("repl","evaluators","repl/evaluators",84539740)], null);
return (eql.cljs$core$IFn$_invoke$arity$1 ? eql.cljs$core$IFn$_invoke$arity$1(G__51261) : eql.call(null,G__51261));
})();
return (function() {
...
return promesa.protocols._promise((function (){var G__51262 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([original_seed,seed], 0));
var G__51263 = query;
return (eql.cljs$core$IFn$_invoke$arity$2 ? eql.cljs$core$IFn$_invoke$arity$2(G__51262,G__51263) : eql.call(null,G__51262,G__51263));
})());
}));
}));
}));
...
repl_tooling.editor_integration.renderer.interactive.render_interactive = (function repl_tooling$editor_integration$renderer$interactive$render_interactive(p__51264,repl,editor_state){
var map__51265 = p__51264;
var map__51265__$1 = cljs.core.__destructure_map(map__51265);
var edn = map__51265__$1;
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51265__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var html = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51265__$1,new cljs.core.Keyword(null,"html","html",-998796897));
var fns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51265__$1,new cljs.core.Keyword(null,"fns","fns",1185138786));
...
(repl_tooling.editor_integration.renderer.interactive.Interactive.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k51268,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__51272 = k51268;
var G__51272__$1 = (((G__51272 instanceof cljs.core.Keyword))?G__51272.fqn:null);
switch (G__51272__$1) {
case "edn":
return self__.edn;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k51268,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__51273){
var vec__51274 = p__51273;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51274,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51274,(1),null);
...
(repl_tooling.editor_integration.renderer.interactive.Interactive.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__51267){
var self__ = this;
var G__51267__$1 = this;
return (new cljs.core.RecordIter((0),G__51267__$1,3,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"edn","edn",1317840885),new cljs.core.Keyword(null,"repl","repl",-35398667),new cljs.core.Keyword(null,"editor-state","editor-state",579582138)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(repl_tooling.editor_integration.renderer.interactive.Interactive.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51269,other51270){
var self__ = this;
var this51269__$1 = this;
return (((!((other51270 == null)))) && ((((this51269__$1.constructor === other51270.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51269__$1.edn,other51270.edn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51269__$1.repl,other51270.repl)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51269__$1.editor_state,other51270.editor_state)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51269__$1.__extmap,other51270.__extmap)))))))))));
}));
...
(repl_tooling.editor_integration.renderer.interactive.Interactive.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k51268){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k51268);

}
}));

(repl_tooling.editor_integration.renderer.interactive.Interactive.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__51267){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__51278 = cljs.core.keyword_identical_QMARK_;
var expr__51279 = k__4481__auto__;
if(cljs.core.truth_((pred__51278.cljs$core$IFn$_invoke$arity$2 ? pred__51278.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"edn","edn",1317840885),expr__51279) : pred__51278.call(null,new cljs.core.Keyword(null,"edn","edn",1317840885),expr__51279)))){
return (new repl_tooling.editor_integration.renderer.interactive.Interactive(G__51267,self__.repl,self__.editor_state,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51278.cljs$core$IFn$_invoke$arity$2 ? pred__51278.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"repl","repl",-35398667),expr__51279) : pred__51278.call(null,new cljs.core.Keyword(null,"repl","repl",-35398667),expr__51279)))){
return (new repl_tooling.editor_integration.renderer.interactive.Interactive(self__.edn,G__51267,self__.editor_state,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51278.cljs$core$IFn$_invoke$arity$2 ? pred__51278.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"editor-state","editor-state",579582138),expr__51279) : pred__51278.call(null,new cljs.core.Keyword(null,"editor-state","editor-state",579582138),expr__51279)))){
return (new repl_tooling.editor_integration.renderer.interactive.Interactive(self__.edn,self__.repl,G__51267,self__.__meta,self__.__extmap,null));
} else {
return (new repl_tooling.editor_integration.renderer.interactive.Interactive(self__.edn,self__.repl,self__.editor_state,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__51267),null));
}
}
}
}));
...
(repl_tooling.editor_integration.renderer.interactive.Interactive.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__51267){
var self__ = this;
var this__4471__auto____$1 = this;
return (new repl_tooling.editor_integration.renderer.interactive.Interactive(self__.edn,self__.repl,self__.editor_state,G__51267,self__.__extmap,self__.__hash));
}));
 ...
 */
repl_tooling.editor_integration.renderer.interactive.map__GT_Interactive = (function repl_tooling$editor_integration$renderer$interactive$map__GT_Interactive(G__51271){
var extmap__4512__auto__ = (function (){var G__51281 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__51271,new cljs.core.Keyword(null,"edn","edn",1317840885),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"repl","repl",-35398667),new cljs.core.Keyword(null,"editor-state","editor-state",579582138)], 0));
...
return (new repl_tooling.editor_integration.renderer.interactive.Interactive(new cljs.core.Keyword(null,"edn","edn",1317840885).cljs$core$IFn$_invoke$arity$1(G__51271),new cljs.core.Keyword(null,"repl","repl",-35398667).cljs$core$IFn$_invoke$arity$1(G__51271),new cljs.core.Keyword(null,"editor-state","editor-state",579582138).cljs$core$IFn$_invoke$arity$1(G__51271),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
