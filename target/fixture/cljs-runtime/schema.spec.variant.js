...
}catch (e152228){if((e152228 instanceof Object)){
var e_SHARP_ = e152228;
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k152237,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__152244 = k152237;
var G__152244__$1 = (((G__152244 instanceof cljs.core.Keyword))?G__152244.fqn:null);
switch (G__152244__$1) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k152237,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__152252){
var vec__152253 = p__152252;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__152253,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__152253,(1),null);
...
var G__152263 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__152263) : self__.err_f.call(null,G__152263));
}),null)),null));
...
var or__4223__auto____$1 = (function (){var G__152266 = (cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__152266) : self__.post.call(null,G__152266));
})();
...
return (-1524878868 ^ cljs.core.hash_unordered_coll(coll__4469__auto__));
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this152238,other152239){
var self__ = this;
var this152238__$1 = this;
return (((!((other152239 == null)))) && ((((this152238__$1.constructor === other152239.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this152238__$1.pre,other152239.pre)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this152238__$1.options,other152239.options)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this152238__$1.err_f,other152239.err_f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this152238__$1.post,other152239.post)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this152238__$1.__extmap,other152239.__extmap)))))))))))));
}));
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.__extmap,k__4483__auto__)),null));
}
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k152237){
var self__ = this;
var this__4479__auto____$1 = this;
var G__152285 = k152237;
var G__152285__$1 = (((G__152285 instanceof cljs.core.Keyword))?G__152285.fqn:null);
switch (G__152285__$1) {
case "pre":
case "options":
case "err-f":
case "post":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k152237);

}
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__152236){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__152287 = cljs.core.keyword_identical_QMARK_;
var expr__152288 = k__4481__auto__;
if(cljs.core.truth_((pred__152287.cljs$core$IFn$_invoke$arity$2 ? pred__152287.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__152288) : pred__152287.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__152288)))){
return (new schema.spec.variant.VariantSpec(G__152236,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__152287.cljs$core$IFn$_invoke$arity$2 ? pred__152287.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"options","options",99638489),expr__152288) : pred__152287.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__152288)))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__152236,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__152287.cljs$core$IFn$_invoke$arity$2 ? pred__152287.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__152288) : pred__152287.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__152288)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__152236,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__152287.cljs$core$IFn$_invoke$arity$2 ? pred__152287.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"post","post",269697687),expr__152288) : pred__152287.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__152288)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__152236,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__152236),null));
}
}
}
}
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__152236){
var self__ = this;
var this__4471__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__152236,self__.__extmap,self__.__hash));
}));
...
return cljs.core._write(writer__4517__auto__,"schema.spec.variant/VariantSpec");
}));
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__152241){
var extmap__4512__auto__ = (function (){var G__152302 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__152241,new cljs.core.Keyword(null,"pre","pre",2118456869),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)], 0));
if(cljs.core.record_QMARK_(G__152241)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__152302);
} else {
return G__152302;
}
})();
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__152241),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__152241),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__152241),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__152241),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var G__152307 = arguments.length;
switch (G__152307) {
case 2:
