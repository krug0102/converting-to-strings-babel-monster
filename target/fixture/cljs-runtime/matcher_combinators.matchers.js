...
var G__148691 = arguments.length;
switch (G__148691) {
case 1:
...
var or__4223__auto__ = cljs.core.last(cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__148693){
var vec__148694 = p__148693;
var class_or_pred = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__148694,(0),null);
var matcher = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__148694,(1),null);
if(cljs.core.truth_((function (){var fexpr__148697 = matcher_combinators.matchers.__GT_pred(class_or_pred);
return (fexpr__148697.cljs$core$IFn$_invoke$arity$1 ? fexpr__148697.cljs$core$IFn$_invoke$arity$1(value) : fexpr__148697.call(null,value));
})())){
return matcher;
} else {
return null;
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((cljs.core.truth_(new cljs.core.Keyword("matcher-combinators.matchers","match-with?","matcher-combinators.matchers/match-with?",-1554879280).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(value)))?value:((cljs.core.fn_QMARK_(value))?value:((((cljs.core.record_QMARK_(value)) && (cljs.core.map_QMARK_(new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(value)))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(value,new cljs.core.Keyword(null,"expected","expected",1583670997),matcher_combinators.matchers.match_with_values,overrides):((((cljs.core.record_QMARK_(value)) && (cljs.core.coll_QMARK_(new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(value)))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(value,new cljs.core.Keyword(null,"expected","expected",1583670997),matcher_combinators.matchers.match_with_elements,overrides):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(matcher_combinators.core.Absent,cljs.core.type(value)))?value:((cljs.core.map_QMARK_(value))?(function (){var G__148701 = matcher_combinators.matchers.match_with_values(value,overrides);
var fexpr__148700 = matcher_combinators.matchers.matcher_for.cljs$core$IFn$_invoke$arity$2(value,overrides);
return (fexpr__148700.cljs$core$IFn$_invoke$arity$1 ? fexpr__148700.cljs$core$IFn$_invoke$arity$1(G__148701) : fexpr__148700.call(null,G__148701));
})():((cljs.core.coll_QMARK_(value))?(function (){var G__148703 = matcher_combinators.matchers.match_with_elements(value,overrides);
var fexpr__148702 = matcher_combinators.matchers.matcher_for.cljs$core$IFn$_invoke$arity$2(value,overrides);
return (fexpr__148702.cljs$core$IFn$_invoke$arity$1 ? fexpr__148702.cljs$core$IFn$_invoke$arity$1(G__148703) : fexpr__148702.call(null,G__148703));
})():(function (){var fexpr__148705 = matcher_combinators.matchers.matcher_for.cljs$core$IFn$_invoke$arity$2(value,overrides);
return (fexpr__148705.cljs$core$IFn$_invoke$arity$1 ? fexpr__148705.cljs$core$IFn$_invoke$arity$1(value) : fexpr__148705.call(null,value));
})()
...
var G__148707 = arguments.length;
switch (G__148707) {
case 1:
