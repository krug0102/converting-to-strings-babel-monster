...
var or__4223__auto__ = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc) : f.call(null,zloc));
...
var G__152067 = rewrite_clj.zip.move.next(rewrite_clj.zip.walk.process_loc(loc,p_QMARK_,f));
loc = G__152067;
continue;
}
break;
...
var G__152063 = arguments.length;
switch (G__152063) {
case 2:
...
var G__152069 = rewrite_clj.zip.walk.downmost(rewrite_clj.zip.move.right(loc__$1));
loc = G__152069;
continue;
} else {
if(cljs.core.truth_(rewrite_clj.zip.move.up(loc__$1))){
var G__152070 = rewrite_clj.zip.move.up(loc__$1);
loc = G__152070;
continue;
} else {
return loc__$1;
...
var G__152066 = arguments.length;
switch (G__152066) {
case 2:
...
return rewrite_clj.zip.subedit.subedit_node(zloc,(function (p1__152064_SHARP_){
return rewrite_clj.zip.walk.postwalk_subtree(p_QMARK_,f,p1__152064_SHARP_);
}));
}));
