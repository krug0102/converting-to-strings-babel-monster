...
(matcher_combinators.printer.ColorTag.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k147983,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__147996 = k147983;
var G__147996__$1 = (((G__147996 instanceof cljs.core.Keyword))?G__147996.fqn:null);
switch (G__147996__$1) {
case "color":
return self__.color;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k147983,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__148001){
var vec__148002 = p__148001;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__148002,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__148002,(1),null);
...
(matcher_combinators.printer.ColorTag.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__147982){
var self__ = this;
var G__147982__$1 = this;
return (new cljs.core.RecordIter((0),G__147982__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"expression","expression",202311876)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(matcher_combinators.printer.ColorTag.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this147984,other147985){
var self__ = this;
var this147984__$1 = this;
return (((!((other147985 == null)))) && ((((this147984__$1.constructor === other147985.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this147984__$1.color,other147985.color)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this147984__$1.expression,other147985.expression)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this147984__$1.__extmap,other147985.__extmap)))))))));
}));
...
(matcher_combinators.printer.ColorTag.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k147983){
var self__ = this;
var this__4479__auto____$1 = this;
var G__148018 = k147983;
var G__148018__$1 = (((G__148018 instanceof cljs.core.Keyword))?G__148018.fqn:null);
switch (G__148018__$1) {
case "color":
case "expression":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k147983);

}
}));

(matcher_combinators.printer.ColorTag.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__147982){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__148023 = cljs.core.keyword_identical_QMARK_;
var expr__148024 = k__4481__auto__;
if(cljs.core.truth_((pred__148023.cljs$core$IFn$_invoke$arity$2 ? pred__148023.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"color","color",1011675173),expr__148024) : pred__148023.call(null,new cljs.core.Keyword(null,"color","color",1011675173),expr__148024)))){
return (new matcher_combinators.printer.ColorTag(G__147982,self__.expression,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__148023.cljs$core$IFn$_invoke$arity$2 ? pred__148023.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"expression","expression",202311876),expr__148024) : pred__148023.call(null,new cljs.core.Keyword(null,"expression","expression",202311876),expr__148024)))){
return (new matcher_combinators.printer.ColorTag(self__.color,G__147982,self__.__meta,self__.__extmap,null));
} else {
return (new matcher_combinators.printer.ColorTag(self__.color,self__.expression,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__147982),null));
}
}
}));
...
(matcher_combinators.printer.ColorTag.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__147982){
var self__ = this;
var this__4471__auto____$1 = this;
return (new matcher_combinators.printer.ColorTag(self__.color,self__.expression,G__147982,self__.__extmap,self__.__hash));
}));
 ...
 */
matcher_combinators.printer.map__GT_ColorTag = (function matcher_combinators$printer$map__GT_ColorTag(G__147990){
var extmap__4512__auto__ = (function (){var G__148038 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__147990,new cljs.core.Keyword(null,"color","color",1011675173),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"expression","expression",202311876)], 0));
if(cljs.core.record_QMARK_(G__147990)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__148038);
} else {
return G__148038;
}
})();
return (new matcher_combinators.printer.ColorTag(new cljs.core.Keyword(null,"color","color",1011675173).cljs$core$IFn$_invoke$arity$1(G__147990),new cljs.core.Keyword(null,"expression","expression",202311876).cljs$core$IFn$_invoke$arity$1(G__147990),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__148044 = cljs.core.get_global_hierarchy;
return (fexpr__148044.cljs$core$IFn$_invoke$arity$0 ? fexpr__148044.cljs$core$IFn$_invoke$arity$0() : fexpr__148044.call(null));
})());
...
matcher_combinators.printer.markup_expression.cljs$core$IMultiFn$_add_method$arity$3(null,matcher_combinators.model.Mismatch,(function (p__148049){
var map__148050 = p__148049;
var map__148050__$1 = cljs.core.__destructure_map(map__148050);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__148050__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__148050__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
matcher_combinators.printer.markup_expression.cljs$core$IMultiFn$_add_method$arity$3(null,matcher_combinators.model.ExpectedMismatch,(function (p__148055){
var map__148056 = p__148055;
var map__148056__$1 = cljs.core.__destructure_map(map__148056);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__148056__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__148056__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
matcher_combinators.printer.markup_expression.cljs$core$IMultiFn$_add_method$arity$3(null,matcher_combinators.model.TypeMismatch,(function (p__148064){
var map__148065 = p__148064;
var map__148065__$1 = cljs.core.__destructure_map(map__148065);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__148065__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__148065__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
matcher_combinators.printer.colorized_print = (function matcher_combinators$printer$colorized_print(p__148071){
var map__148072 = p__148071;
var map__148072__$1 = cljs.core.__destructure_map(map__148072);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__148072__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var expression = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__148072__$1,new cljs.core.Keyword(null,"expression","expression",202311876));
...
var _STAR_print_pprint_dispatch_STAR__orig_val__148078 = cljs.pprint._STAR_print_pprint_dispatch_STAR_;
var _STAR_print_pprint_dispatch_STAR__temp_val__148079 = matcher_combinators.printer.print_diff_dispatch;
(cljs.pprint._STAR_print_pprint_dispatch_STAR_ = _STAR_print_pprint_dispatch_STAR__temp_val__148079);

try{return cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(expr);
}finally {(cljs.pprint._STAR_print_pprint_dispatch_STAR_ = _STAR_print_pprint_dispatch_STAR__orig_val__148078);
}});
...
var _STAR_print_newline_STAR__orig_val__148085_148124 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__148086_148125 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__148087_148126 = true;
var _STAR_print_fn_STAR__temp_val__148088_148127 = (function (x__4761__auto__){
return sb__4760__auto__.append(x__4761__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__148087_148126);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__148088_148127);

try{matcher_combinators.printer.pretty_print(value);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__148086_148125);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__148085_148124);
}
