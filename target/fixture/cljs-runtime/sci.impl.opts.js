...
var len__4829__auto___155258 = arguments.length;
var i__4830__auto___155259 = (0);
while(true){
if((i__4830__auto___155259 < len__4829__auto___155258)){
args__4835__auto__.push((arguments[i__4830__auto___155259]));

var G__155260 = (i__4830__auto___155259 + (1));
i__4830__auto___155259 = G__155260;
continue;
} else {
}
break;
...
return sci.impl.opts.process_permissions.cljs$core$IFn$_invoke$arity$variadic(argseq__4836__auto__);
});
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq155250){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq155250));
}));
...
var G__155261 = null;
var G__155261__1 = (function (msg){
return (new Error(msg));
});
var G__155261__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__155261__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__155261 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__155261__1.call(this,msg);
case 2:
return G__155261__2.call(this,msg,filename);
case 3:
return G__155261__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__155261.cljs$core$IFn$_invoke$arity$1 = G__155261__1;
G__155261.cljs$core$IFn$_invoke$arity$2 = G__155261__2;
G__155261.cljs$core$IFn$_invoke$arity$3 = G__155261__3;
return G__155261;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__155251_SHARP_){
return (new cljs.core.Delay(p1__155251_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__155252_SHARP_){
return (new goog.string.StringBuffer(p1__155252_SHARP_));
})], null)], null);
...
var vec__155253 = temp__5751__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__155253,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__155253,(1),null);
var G__155262 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__155263 = cljs.core.rest(kvs);
class__GT_opts = G__155262;
kvs = G__155263;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__155256){
var map__155257 = p__155256;
var map__155257__$1 = cljs.core.__destructure_map(map__155257);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var preset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"preset","preset",777387345));
var realize_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var uberscript = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"uberscript","uberscript",701571092));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__155257__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var ctx = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"features","features",-1146962336),new cljs.core.Keyword("sci.impl.opts","ctx","sci.impl.opts/ctx",-367410399),new cljs.core.Keyword(null,"bindings","bindings",1271397192),new cljs.core.Keyword(null,"readers","readers",-2118263030),new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"allow","allow",-1857325745),new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543),new cljs.core.Keyword(null,"uberscript","uberscript",701571092),new cljs.core.Keyword(null,"deny","deny",1589338523)],[features,true,cljs.core.PersistentArrayMap.EMPTY,readers,env__$1,sci.impl.opts.process_permissions.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"allow","allow",-1857325745).cljs$core$IFn$_invoke$arity$1(preset__$1),allow], 0)),(function (){var or__4223__auto__ = realize_max;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543).cljs$core$IFn$_invoke$arity$1(preset__$1);
}
})(),uberscript,sci.impl.opts.process_permissions.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"deny","deny",1589338523).cljs$core$IFn$_invoke$arity$1(preset__$1),deny], 0))]),sci.impl.opts.normalize_classes(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([sci.impl.opts.default_classes,classes], 0)))], 0));
return ctx;
});
