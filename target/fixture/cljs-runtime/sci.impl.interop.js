...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__154237){
var vec__154238 = p__154237;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154238,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154238,(1),null);
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__154244,args){
var vec__154246 = p__154244;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154246,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154246,(1),null);
...
var vec__154261 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(method_name__$1,/\./);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154261,(0),null);
var sub_method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154261,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__154264,sym){
var map__154265 = p__154264;
var map__154265__$1 = cljs.core.__destructure_map(map__154265);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154265__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154265__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
var or__4223__auto__ = (function (){var temp__5751__auto__ = cljs.core.namespace(sym);
if(cljs.core.truth_(temp__5751__auto__)){
...
var or__4223__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"imports","imports",-1249933394).cljs$core$IFn$_invoke$arity$1(env__$1),sym);
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__154271,sym){
var map__154272 = p__154271;
var map__154272__$1 = cljs.core.__destructure_map(map__154272);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154272__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154272__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
var class_opts = (function (){var or__4223__auto__ = (function (){var temp__5751__auto__ = cljs.core.namespace(sym);
if(cljs.core.truth_(temp__5751__auto__)){
var ns_STAR_ = temp__5751__auto__;
if(("js" === ns_STAR_)){
...
var env__$1 = cljs.core.deref(env);
var or__4223__auto____$1 = (function (){var temp__5753__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"imports","imports",-1249933394),sym], null));
...
var cnn = sci.impl.vars.current_ns_name();
var temp__5753__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env__$1,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469),cnn,new cljs.core.Keyword(null,"imports","imports",-1249933394),sym], null));
if(cljs.core.truth_(temp__5753__auto__)){
var v = temp__5753__auto__;
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(class__GT_opts,v);
} else {
