...
shadow.js.shim.module$fs.readFile(config_file,(function (p1__140652_SHARP_,p2__140651_SHARP_){
return promesa.core.resolve_BANG_.cljs$core$IFn$_invoke$arity$2(p,cljs.core.str.cljs$core$IFn$_invoke$arity$1(p2__140651_SHARP_));
}));
...
return promesa.protocols._promise(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__140665){
var vec__140667 = p__140665;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__140667,(0),null);
var fun = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__140667,(1),null);
...
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__140674){
var vec__140676 = p__140674;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__140676,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__140676,(1),null);
...
var serialized_140751 = cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.tagged_literal(new cljs.core.Symbol(null,"error","error",661562495,null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),error.name,new cljs.core.Keyword(null,"data","data",-232669377),error.data,new cljs.core.Keyword(null,"message","message",-406056002),error.message,new cljs.core.Keyword(null,"trace","trace",-1082747415),clojure.string.split_lines(error.stack)], null))], 0));
var data_140752 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.gensym.cljs$core$IFn$_invoke$arity$1("sci-error-"),new cljs.core.Keyword(null,"result","result",1415092211),repl_tooling.editor_helpers.parse_result(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"error","error",-978969032),serialized_140751,new cljs.core.Keyword(null,"as-text","as-text",-449861067),serialized_140751], null))], null);
var error_data_140753 = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(error);
var data_140754__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(error_data_140753),new cljs.core.Keyword("sci","error","sci/error",-979082803)))?(function (){var rowcol = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(error_data_140753) - (1)),(new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(error_data_140753) - (1))], null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(data_140752,new cljs.core.Keyword(null,"range","range",1639692286),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [rowcol,rowcol], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"editor-data","editor-data",-2084300305),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"filename","filename",-1428840783),config_file,new cljs.core.Keyword(null,"contents","contents",-1567174023),"",new cljs.core.Keyword(null,"range","range",1639692286),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [rowcol,rowcol], null)], null)], 0));
})():cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(data_140752,new cljs.core.Keyword(null,"range","range",1639692286),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null)], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"editor-data","editor-data",-2084300305),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"filename","filename",-1428840783),null,new cljs.core.Keyword(null,"contents","contents",-1567174023),"",new cljs.core.Keyword(null,"range","range",1639692286),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null)], null)], null)], 0)));
repl_tooling.editor_integration.commands.run_callback_BANG_.cljs$core$IFn$_invoke$arity$variadic(editor_state,new cljs.core.Keyword(null,"on-start-eval","on-start-eval",-560475418),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(data_140754__$1,new cljs.core.Keyword(null,"result","result",1415092211))], 0));

repl_tooling.editor_integration.commands.run_callback_BANG_.cljs$core$IFn$_invoke$arity$variadic(editor_state,new cljs.core.Keyword(null,"on-eval","on-eval",-1349336659),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_140754__$1,new cljs.core.Keyword(null,"repl","repl",-35398667),null)], 0));
...
repl_tooling.ui.pinkie.register_tag(new cljs.core.Keyword("div","clj","div/clj",-660599991),(function (p1__140726_SHARP_){
return repl_tooling.editor_integration.configs.clojure_renderer(editor_state,p1__140726_SHARP_);
}));
