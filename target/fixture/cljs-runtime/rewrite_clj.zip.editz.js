...
return rewrite_clj.node.protocols.coerce((function (){var G__151968 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__151968) : f.call(null,G__151968));
})());
});
});
/**
...
var len__4829__auto___152006 = arguments.length;
var i__4830__auto___152007 = (0);
while(true){
if((i__4830__auto___152007 < len__4829__auto___152006)){
args__4835__auto__.push((arguments[i__4830__auto___152007]));

var G__152008 = (i__4830__auto___152007 + (1));
i__4830__auto___152007 = G__152008;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.base.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__151973_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__151973_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq151974){
var G__151975 = cljs.core.first(seq151974);
var seq151974__$1 = cljs.core.next(seq151974);
var G__151976 = cljs.core.first(seq151974__$1);
var seq151974__$2 = cljs.core.next(seq151974__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__151975,G__151976,seq151974__$2);
}));
...
var temp__5751__auto__ = cljs.core.seq(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.whitespace.whitespace_QMARK_,cljs.core.reverse(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.whitespace.whitespace_QMARK_,rewrite_clj.custom_zipper.core.children(zloc)))));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__151993 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__151993) : str_fn.call(null,G__151993));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__151994 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__151994) : str_fn.call(null,G__151994));
})()):null)));
...
var G__152000 = rewrite_clj.zip.base.tag(zloc);
var G__152000__$1 = (((G__152000 instanceof cljs.core.Keyword))?G__152000.fqn:null);
switch (G__152000__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__151997_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__151997_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__151998_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__151998_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__152000__$1)].join('')));
...
var G__152002 = rewrite_clj.zip.base.tag(zloc);
var G__152002__$1 = (((G__152002 instanceof cljs.core.Keyword))?G__152002.fqn:null);
switch (G__152002__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__152001_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__152001_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__152002__$1)].join('')));
