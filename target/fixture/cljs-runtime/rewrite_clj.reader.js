...
var len__4829__auto___151393 = arguments.length;
var i__4830__auto___151394 = (0);
while(true){
if((i__4830__auto___151394 < len__4829__auto___151393)){
args__4835__auto__.push((arguments[i__4830__auto___151394]));

var G__151395 = (i__4830__auto___151394 + (1));
i__4830__auto___151394 = G__151395;
continue;
} else {
}
break;
...
/** @this {Function} */
(rewrite_clj.reader.throw_reader.cljs$lang$applyTo = (function (seq151378){
var G__151379 = cljs.core.first(seq151378);
var seq151378__$1 = cljs.core.next(seq151378);
var G__151380 = cljs.core.first(seq151378__$1);
var seq151378__$2 = cljs.core.next(seq151378__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__151379,G__151380,seq151378__$2);
}));
...
var and__4221__auto____$1 = rewrite_clj.reader.whitespace_QMARK_(c);
...
var or__4223__auto__ = rewrite_clj.reader.whitespace_QMARK_(c);
...
var G__151387 = arguments.length;
switch (G__151387) {
case 2:
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(rewrite_clj.reader.read_until(reader,(function (p1__151390_SHARP_){
return (((p1__151390_SHARP_ == null)) || (rewrite_clj.reader.linebreak_QMARK_(p1__151390_SHARP_)));
...
var G__151397 = (cljs.core.truth_((p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(v) : p_QMARK_.call(null,v)))?(c + (1)):c);
var G__151398 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vs,v);
c = G__151397;
vs = G__151398;
continue;
} else {
