...
var G__146061 = arguments.length;
switch (G__146061) {
case 2:
...
var G__146065 = new cljs.core.Keyword(null,"env","env",-1815813235).cljs$core$IFn$_invoke$arity$1(ast__$1);
var G__146066 = ast__$1;
var G__146067 = opts;
return (pass.cljs$core$IFn$_invoke$arity$3 ? pass.cljs$core$IFn$_invoke$arity$3(G__146065,G__146066,G__146067) : pass.call(null,G__146065,G__146066,G__146067));
}),ast,passes);
}));
...
var G__146074 = arguments.length;
switch (G__146074) {
case 2:
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__146072_SHARP_){
return cljs.analyzer.passes.walk.cljs$core$IFn$_invoke$arity$3(p1__146072_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.cljs$core$IFn$_invoke$arity$3(child,passes,opts);
}
})());
}),(function (){var G__146078 = ast;
if((G__146078 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.cljs$core$IFn$_invoke$arity$3(G__146078,passes,opts);
}
