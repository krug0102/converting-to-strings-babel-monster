...
var len__4829__auto___152028 = arguments.length;
var i__4830__auto___152029 = (0);
while(true){
if((i__4830__auto___152029 < len__4829__auto___152028)){
args__4835__auto__.push((arguments[i__4830__auto___152029]));

var G__152030 = (i__4830__auto___152029 + (1));
i__4830__auto___152029 = G__152030;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__151969){
var vec__151970 = p__151969;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151970,(0),null);
...
return (function (p1__151964_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__151964_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq151965){
var G__151966 = cljs.core.first(seq151965);
var seq151965__$1 = cljs.core.next(seq151965);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__151966,seq151965__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__151979 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151979,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151979,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__151982 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__151985 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151982,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151985,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151985,(1),null);
var vec__151988 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151982,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151988,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151988,(1),null);
var and__4221__auto__ = (r >= zstart_row);
if(and__4221__auto__){
var and__4221__auto____$1 = (r <= zend_row);
if(and__4221__auto____$1){
var and__4221__auto____$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(r,zstart_row))?(c >= zstart_col):true);
...
var G__151992 = arguments.length;
switch (G__151992) {
case 2:
...
var G__151999 = arguments.length;
switch (G__151999) {
case 2:
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__151995_SHARP_){
var and__4221__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__151995_SHARP_) : p_QMARK_.call(null,p1__151995_SHARP_));
if(cljs.core.truth_(and__4221__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__151995_SHARP_,pos);
} else {
return and__4221__auto__;
}
...
var G__152004 = arguments.length;
switch (G__152004) {
case 2:
...
var G__152005 = zloc;
var G__152005__$1 = (((G__152005 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__152005) : f.call(null,G__152005)));
if((G__152005__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__152005__$1,f,p_QMARK_);
}
}));
...
var G__152011 = arguments.length;
switch (G__152011) {
case 2:
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__152009_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__152009_SHARP_),t);
}));
}));
...
var G__152015 = arguments.length;
switch (G__152015) {
case 2:
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__152016_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__152016_SHARP_),t);
}));
});
/**
...
var G__152018 = arguments.length;
switch (G__152018) {
case 2:
...
var G__152020 = arguments.length;
switch (G__152020) {
case 2:
...
var G__152023 = arguments.length;
switch (G__152023) {
case 2:
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__152021_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__152021_SHARP_),v);
}));
...
var G__152027 = arguments.length;
switch (G__152027) {
case 2:
