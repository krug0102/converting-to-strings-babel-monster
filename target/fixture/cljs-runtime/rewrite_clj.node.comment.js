...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k151146,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__151164 = k151146;
var G__151164__$1 = (((G__151164 instanceof cljs.core.Keyword))?G__151164.fqn:null);
switch (G__151164__$1) {
case "prefix":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k151146,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__151167){
var vec__151168 = p__151167;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151168,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151168,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__151145){
var self__ = this;
var G__151145__$1 = this;
return (new cljs.core.RecordIter((0),G__151145__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this151147,other151148){
var self__ = this;
var this151147__$1 = this;
return (((!((other151148 == null)))) && ((((this151147__$1.constructor === other151148.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151147__$1.prefix,other151148.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151147__$1.s,other151148.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151147__$1.__extmap,other151148.__extmap)))))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k151146){
var self__ = this;
var this__4479__auto____$1 = this;
var G__151206 = k151146;
var G__151206__$1 = (((G__151206 instanceof cljs.core.Keyword))?G__151206.fqn:null);
switch (G__151206__$1) {
case "prefix":
case "s":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k151146);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__151145){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__151207 = cljs.core.keyword_identical_QMARK_;
var expr__151208 = k__4481__auto__;
if(cljs.core.truth_((pred__151207.cljs$core$IFn$_invoke$arity$2 ? pred__151207.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__151208) : pred__151207.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__151208)))){
return (new rewrite_clj.node.comment.CommentNode(G__151145,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__151207.cljs$core$IFn$_invoke$arity$2 ? pred__151207.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__151208) : pred__151207.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__151208)))){
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,G__151145,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__151145),null));
}
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__151145){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,G__151145,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__151152){
var extmap__4512__auto__ = (function (){var G__151216 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__151152,new cljs.core.Keyword(null,"prefix","prefix",-265908465),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"s","s",1705939918)], 0));
if(cljs.core.record_QMARK_(G__151152)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__151216);
} else {
return G__151216;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__151152),new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__151152),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var G__151218 = arguments.length;
switch (G__151218) {
case 1:
