...
rewrite_clj.zip.base.get_opts = (function rewrite_clj$zip$base$get_opts(zloc){
...
rewrite_clj.zip.base.set_opts = (function rewrite_clj$zip$base$set_opts(zloc,opts){
return cljs.core.with_meta(zloc,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.meta(zloc),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("rewrite-clj.zip","opts","rewrite-clj.zip/opts",-1382883702),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983),rewrite_clj.node.protocols.default_auto_resolve], null),opts], 0))], null)], 0)));
});
/**
...
var G__151930 = arguments.length;
switch (G__151930) {
case 1:
...
return rewrite_clj.zip.base.set_opts((cljs.core.truth_(new cljs.core.Keyword(null,"track-position?","track-position?",1860535489).cljs$core$IFn$_invoke$arity$1(opts))?rewrite_clj.custom_zipper.core.custom_zipper(node):rewrite_clj.custom_zipper.core.zipper(node)),opts);
}));
...
var G__151932 = arguments.length;
switch (G__151932) {
case 1:
...
var or__4223__auto__ = rewrite_clj.zip.whitespace.skip_whitespace.cljs$core$IFn$_invoke$arity$1(rewrite_clj.custom_zipper.core.down(top));
...
var G__151962 = rewrite_clj.node.forms.forms_node(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [node__$1], null));
var G__151963 = opts__$1;
node__$1 = G__151962;
opts__$1 = G__151963;
continue;
}
...
var G__151933 = zloc;
var G__151933__$1 = (((G__151933 == null))?null:rewrite_clj.custom_zipper.core.node(G__151933));
if((G__151933__$1 == null)){
return null;
} else {
return rewrite_clj.node.protocols.tag(G__151933__$1);
}
});
/**
...
var G__151934 = zloc;
var G__151934__$1 = (((G__151934 == null))?null:rewrite_clj.custom_zipper.core.node(G__151934));
if((G__151934__$1 == null)){
return null;
} else {
return rewrite_clj.node.protocols.sexpr_able_QMARK_(G__151934__$1);
}
});
/**
...
var G__151935 = zloc;
var G__151935__$1 = (((G__151935 == null))?null:rewrite_clj.custom_zipper.core.node(G__151935));
if((G__151935__$1 == null)){
return null;
} else {
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(G__151935__$1,rewrite_clj.zip.base.get_opts(zloc));
}
});
/**
...
var G__151936 = zloc;
var G__151936__$1 = (((G__151936 == null))?null:rewrite_clj.custom_zipper.core.node(G__151936));
if((G__151936__$1 == null)){
return null;
} else {
return rewrite_clj.node.protocols.child_sexprs.cljs$core$IFn$_invoke$arity$2(G__151936__$1,rewrite_clj.zip.base.get_opts(zloc));
}
});
/**
...
var or__4223__auto__ = (function (){var G__151937 = zloc;
var G__151937__$1 = (((G__151937 == null))?null:rewrite_clj.custom_zipper.core.node(G__151937));
if((G__151937__$1 == null)){
return null;
} else {
return rewrite_clj.node.protocols.length(G__151937__$1);
}
})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
var G__151938 = zloc;
var G__151938__$1 = (((G__151938 == null))?null:rewrite_clj.custom_zipper.core.node(G__151938));
if((G__151938__$1 == null)){
return null;
} else {
return rewrite_clj.node.protocols.value(G__151938__$1);
}
});
/**
...
var G__151940 = arguments.length;
switch (G__151940) {
case 1:
...
var G__151941 = s;
var G__151941__$1 = (((G__151941 == null))?null:rewrite_clj.parser.parse_string_all(G__151941));
if((G__151941__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.edn.cljs$core$IFn$_invoke$arity$2(G__151941__$1,opts);
}
}));
...
var G__151943 = zloc;
var G__151943__$1 = (((G__151943 == null))?null:rewrite_clj.custom_zipper.core.node(G__151943));
if((G__151943__$1 == null)){
return null;
} else {
return rewrite_clj.node.protocols.string(G__151943__$1);
}
});
/**
...
var G__151945 = zloc;
var G__151945__$1 = (((G__151945 == null))?null:rewrite_clj.custom_zipper.core.root(G__151945));
if((G__151945__$1 == null)){
return null;
} else {
return rewrite_clj.node.protocols.string(G__151945__$1);
}
});
/**
...
var G__151949 = arguments.length;
switch (G__151949) {
case 2:
...
var G__151950 = zloc;
var G__151950__$1 = (((G__151950 == null))?null:rewrite_clj.zip.base.string(G__151950));
if((G__151950__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.print_BANG_(G__151950__$1,writer);
}
}));
...
var G__151953 = arguments.length;
switch (G__151953) {
case 2:
...
var G__151955 = zloc;
var G__151955__$1 = (((G__151955 == null))?null:rewrite_clj.zip.base.root_string(G__151955));
if((G__151955__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.print_BANG_(G__151955__$1,writer);
}
}));
