...
var G__150646 = clojure.zip.node(loc);
var fexpr__150645 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__150645.cljs$core$IFn$_invoke$arity$1 ? fexpr__150645.cljs$core$IFn$_invoke$arity$1(G__150646) : fexpr__150645.call(null,G__150646));
});
/**
...
var G__150649 = clojure.zip.node(loc);
var fexpr__150648 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__150648.cljs$core$IFn$_invoke$arity$1 ? fexpr__150648.cljs$core$IFn$_invoke$arity$1(G__150649) : fexpr__150648.call(null,G__150649));
} else {
...
var fexpr__150651 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__150651.cljs$core$IFn$_invoke$arity$2 ? fexpr__150651.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__150651.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__150652 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150652,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150652,(1),null);
var vec__150655 = clojure.zip.children(loc);
var seq__150656 = cljs.core.seq(vec__150655);
var first__150657 = cljs.core.first(seq__150656);
var seq__150656__$1 = cljs.core.next(seq__150656);
var c = first__150657;
var cnext = seq__150656__$1;
var cs = vec__150655;
...
var vec__150658 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150658,(0),null);
var map__150661 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150658,(1),null);
var map__150661__$1 = cljs.core.__destructure_map(map__150661);
var path = map__150661__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150661__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150661__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150661__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150661__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150661__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__150670 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150670,(0),null);
var map__150673 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150670,(1),null);
var map__150673__$1 = cljs.core.__destructure_map(map__150673);
var path = map__150673__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150673__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__150674 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150673__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__150675 = cljs.core.seq(vec__150674);
var first__150676 = cljs.core.first(seq__150675);
var seq__150675__$1 = cljs.core.next(seq__150675);
var r = first__150676;
var rnext = seq__150675__$1;
var rs = vec__150674;
...
var vec__150681 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150681,(0),null);
var map__150684 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150681,(1),null);
var map__150684__$1 = cljs.core.__destructure_map(map__150684);
var path = map__150684__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150684__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150684__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return r;
} else {
...
var vec__150690 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150690,(0),null);
var map__150694 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150690,(1),null);
var map__150694__$1 = cljs.core.__destructure_map(map__150694);
var path = map__150694__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150694__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150694__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
...
var vec__150695 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150695,(0),null);
var map__150698 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150695,(1),null);
var map__150698__$1 = cljs.core.__destructure_map(map__150698);
var path = map__150698__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150698__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150698__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__150699 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150699,(0),null);
var map__150702 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150699,(1),null);
var map__150702__$1 = cljs.core.__destructure_map(map__150702);
var path = map__150702__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150702__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__150703 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150703,(0),null);
var map__150706 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150703,(1),null);
var map__150706__$1 = cljs.core.__destructure_map(map__150706);
var path = map__150706__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150706__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__150712 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150712,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150712,(1),null);
...
var len__4829__auto___150783 = arguments.length;
var i__4830__auto___150784 = (0);
while(true){
if((i__4830__auto___150784 < len__4829__auto___150783)){
args__4835__auto__.push((arguments[i__4830__auto___150784]));

var G__150785 = (i__4830__auto___150784 + (1));
i__4830__auto___150784 = G__150785;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq150715){
var G__150716 = cljs.core.first(seq150715);
var seq150715__$1 = cljs.core.next(seq150715);
var G__150717 = cljs.core.first(seq150715__$1);
var seq150715__$2 = cljs.core.next(seq150715__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__150716,G__150717,seq150715__$2);
}));
...
var G__150788 = clojure.zip.up(p);
p = G__150788;
continue;
}
} else {
...
var G__150789 = clojure.zip.rightmost(child);
loc__$1 = G__150789;
continue;
} else {
return loc__$1;
...
var vec__150728 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150728,(0),null);
var map__150731 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150728,(1),null);
var map__150731__$1 = cljs.core.__destructure_map(map__150731);
var path = map__150731__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150731__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150731__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150731__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150731__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__150790 = clojure.zip.rightmost(child);
loc__$1 = G__150790;
continue;
} else {
return loc__$1;
