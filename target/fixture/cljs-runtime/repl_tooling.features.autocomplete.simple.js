...
return cljs.core.vec((function (){var G__138329 = result;
var G__138329__$1 = (((G__138329 == null))?null:repl_tooling.editor_helpers.parse_result(G__138329));
var G__138329__$2 = (((G__138329__$1 == null))?null:new cljs.core.Keyword(null,"result","result",1415092211).cljs$core$IFn$_invoke$arity$1(G__138329__$1));
if((G__138329__$2 == null)){
return null;
} else {
...
repl_tooling.features.autocomplete.simple.re_char_escapes = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,(function (p1__138333_SHARP_){
return ["\\",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__138333_SHARP_)].join('');
})),cljs.core.set("\\.*+|?()[]{}$^")));
