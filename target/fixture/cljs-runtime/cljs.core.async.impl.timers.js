...
var G__148846 = arguments.length;
switch (G__148846) {
case 0:
...
var G__148889 = arguments.length;
switch (G__148889) {
case 1:
...
var i_148904 = (0);
while(true){
if((i_148904 < arr.length)){
(arr[i_148904] = null);

var G__148905 = (i_148904 + (1));
i_148904 = G__148905;
continue;
} else {
}
...
var G__148898 = arguments.length;
switch (G__148898) {
case 3:
...
var G__148908 = x__$1;
var G__148909 = k;
var G__148910 = (level - (1));
var G__148911 = update;
x = G__148908;
k = G__148909;
level = G__148910;
update = G__148911;
...
var i_148912 = (self__.level + (1));
while(true){
if((i_148912 <= (new_level + (1)))){
(update[i_148912] = self__.header);

var G__148913 = (i_148912 + (1));
i_148912 = G__148913;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_148914 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_148914[i]));
} else {
x__$2.forward.push((((i < links_148914.length))?(links_148914[i]):null));
}

if((i < links_148914.length)){
(links_148914[i] = x__$2);
} else {
links_148914.push(x__$2);
}
...
var i_148916 = (0);
while(true){
if((i_148916 <= self__.level)){
var links_148917 = (update[i_148916]).forward;
if((x__$1 === (((i_148916 < links_148917.length))?(links_148917[i_148916]):null))){
(links_148917[i_148916] = (x__$1.forward[i_148916]));

var G__148918 = (i_148916 + (1));
i_148916 = G__148918;
continue;
} else {
var G__148919 = (i_148916 + (1));
i_148916 = G__148919;
continue;
}
} else {
...
var G__148921 = nx;
var G__148922 = (level__$1 - (1));
x = G__148921;
level__$1 = G__148922;
continue;
} else {
var G__148923 = x;
var G__148924 = (level__$1 - (1));
x = G__148923;
level__$1 = G__148924;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__148927 = nx;
var G__148928 = (level__$1 - (1));
x = G__148927;
level__$1 = G__148928;
continue;
} else {
var G__148929 = x;
var G__148930 = (level__$1 - (1));
x = G__148929;
level__$1 = G__148930;
continue;
}
