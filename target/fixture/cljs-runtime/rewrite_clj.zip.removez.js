...
var and__4221__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),rewrite_clj.zip.removez.node_depth(zloc));
if(and__4221__auto__){
var and__4221__auto____$1 = cljs.core.not(rewrite_clj.zip.move.right(zloc));
...
var G__151944 = arguments.length;
switch (G__151944) {
case 1:
...
var G__151947 = arguments.length;
switch (G__151947) {
case 1:
...
return rewrite_clj.zip.whitespace.skip_whitespace.cljs$core$IFn$_invoke$arity$2(rewrite_clj.custom_zipper.core.prev,rewrite_clj.custom_zipper.core.remove((function (){var G__151951 = (left_ws_trim_fn.cljs$core$IFn$_invoke$arity$1 ? left_ws_trim_fn.cljs$core$IFn$_invoke$arity$1(zloc) : left_ws_trim_fn.call(null,zloc));
return (right_ws_trim_fn.cljs$core$IFn$_invoke$arity$1 ? right_ws_trim_fn.cljs$core$IFn$_invoke$arity$1(G__151951) : right_ws_trim_fn.call(null,G__151951));
})()));
});
/**
...
var _PERCENT_ = (function (){var ws_pred_fn = (function (p1__151954_SHARP_){
var and__4221__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_(p1__151954_SHARP_);
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.not(rewrite_clj.zip.whitespace.linebreak_QMARK_(p1__151954_SHARP_));
} else {
return and__4221__auto__;
}
});
return rewrite_clj.zip.removez.remove_with_trim(zloc,(function (p1__151956_SHARP_){
return rewrite_clj.zip.removez.left_ws_trim.cljs$core$IFn$_invoke$arity$2(p1__151956_SHARP_,ws_pred_fn);
}),(function (p1__151957_SHARP_){
return rewrite_clj.zip.removez.right_ws_trim.cljs$core$IFn$_invoke$arity$2(p1__151957_SHARP_,ws_pred_fn);
}));
})();
if(cljs.core.truth_(_PERCENT_)){
} else {
