...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k151529,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__151535 = k151529;
var G__151535__$1 = (((G__151535 instanceof cljs.core.Keyword))?G__151535.fqn:null);
switch (G__151535__$1) {
case "value":
return self__.value;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k151529,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__151540){
var vec__151542 = p__151540;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151542,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151542,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__151528){
var self__ = this;
var G__151528__$1 = this;
return (new cljs.core.RecordIter((0),G__151528__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this151530,other151531){
var self__ = this;
var this151530__$1 = this;
return (((!((other151531 == null)))) && ((((this151530__$1.constructor === other151531.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151530__$1.value,other151531.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151530__$1.base,other151531.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151530__$1.__extmap,other151531.__extmap)))))))));
}));
...
var abs_value = (function (){var G__151560 = self__.value;
if((self__.value < (0))){
return (- G__151560);
} else {
return G__151560;
...
var prefix = (function (){var G__151561 = cljs.core.long$(self__.base);
switch (G__151561) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k151529){
var self__ = this;
var this__4479__auto____$1 = this;
var G__151562 = k151529;
var G__151562__$1 = (((G__151562 instanceof cljs.core.Keyword))?G__151562.fqn:null);
switch (G__151562__$1) {
case "value":
case "base":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k151529);

}
}));

(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__151528){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__151563 = cljs.core.keyword_identical_QMARK_;
var expr__151564 = k__4481__auto__;
if(cljs.core.truth_((pred__151563.cljs$core$IFn$_invoke$arity$2 ? pred__151563.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__151564) : pred__151563.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__151564)))){
return (new rewrite_clj.node.integer.IntNode(G__151528,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__151563.cljs$core$IFn$_invoke$arity$2 ? pred__151563.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__151564) : pred__151563.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__151564)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__151528,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__151528),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__151528){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__151528,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__151532){
var extmap__4512__auto__ = (function (){var G__151567 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__151532,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__151532)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__151567);
} else {
return G__151567;
}
})();
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__151532),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__151532),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var G__151569 = arguments.length;
switch (G__151569) {
case 1:
