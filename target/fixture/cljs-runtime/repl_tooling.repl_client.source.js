...
var G__152964 = command;
if(cljs.core.contains_QMARK_(command,new cljs.core.Keyword(null,"children","children",-940561982))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__152964,new cljs.core.Keyword(null,"children","children",-940561982),(function (p1__152962_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(repl_tooling.repl_client.source.conv_node,p1__152962_SHARP_);
}));
} else {
return G__152964;
}
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__152967 = res;
if(cljs.core.truth_(remove_lines_QMARK_)){
return repl_tooling.repl_client.source.normalize_command(G__152967);
} else {
return G__152967;
}
})())], null);
...
var G__152976 = arguments.length;
switch (G__152976) {
case 4:
