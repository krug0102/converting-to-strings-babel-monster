...
var schema$spec$core$CoreSpec$subschemas$dyn_152206 = (function (this$){
...
return schema$spec$core$CoreSpec$subschemas$dyn_152206(this$);
}
});

var schema$spec$core$CoreSpec$checker$dyn_152207 = (function (this$,params){
var x__4521__auto__ = (((this$ == null))?null:this$);
var m__4522__auto__ = (schema.spec.core.checker[goog.typeOf(x__4521__auto__)]);
if((!((m__4522__auto__ == null)))){
return (m__4522__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4522__auto__.cljs$core$IFn$_invoke$arity$2(this$,params) : m__4522__auto__.call(null,this$,params));
} else {
var m__4519__auto__ = (schema.spec.core.checker["_"]);
if((!((m__4519__auto__ == null)))){
return (m__4519__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4519__auto__.cljs$core$IFn$_invoke$arity$2(this$,params) : m__4519__auto__.call(null,this$,params));
} else {
...
return schema$spec$core$CoreSpec$checker$dyn_152207(this$,params);
}
});
...
}catch (e152187){if((e152187 instanceof Object)){
var e_SHARP_ = e152187;
...
var G__152188 = schema.utils.value_name(x);
return (err_f.cljs$core$IFn$_invoke$arity$1 ? err_f.cljs$core$IFn$_invoke$arity$1(G__152188) : err_f.call(null,G__152188));
}),null)),reason));
} else {
return null;
}
...
var G__152195 = (new cljs.core.Delay((function (){
var fexpr__152196 = cljs.core.deref(cache);
return (fexpr__152196.cljs$core$IFn$_invoke$arity$1 ? fexpr__152196.cljs$core$IFn$_invoke$arity$1(cache_key) : fexpr__152196.call(null,cache_key));
}),null));
return (wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1 ? wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1(G__152195) : wrap_recursive_delay.call(null,G__152195));
} else {
return w;
}
} else {
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__152197,p__152198){
var map__152199 = p__152197;
var map__152199__$1 = cljs.core.__destructure_map(map__152199);
var schema__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__152199__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__152199__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__152200 = p__152198;
var map__152200__$1 = cljs.core.__destructure_map(map__152200);
var params = map__152200__$1;
var subschema_checker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__152200__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__152200__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache(cache,schema__$1,(function (d){
return (function (x){
var fexpr__152203 = cljs.core.deref(d);
return (fexpr__152203.cljs$core$IFn$_invoke$arity$1 ? fexpr__152203.cljs$core$IFn$_invoke$arity$1(x) : fexpr__152203.call(null,x));
});
}),(function (){
