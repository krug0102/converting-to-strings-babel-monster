...
return com.wsscode.misc.refs.kw_identical_QMARK_(new cljs.core.Keyword(null,"union","union",2142937499),(function (){var G__157822 = ast;
var G__157822__$1 = (((G__157822 == null))?null:new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__157822));
var G__157822__$2 = (((G__157822__$1 == null))?null:cljs.core.first(G__157822__$1));
if((G__157822__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__157822__$2);
}
})());
});
/**
...
com.wsscode.pathom3.format.eql.union_key_on_data_QMARK_ = (function com$wsscode$pathom3$format$eql$union_key_on_data_QMARK_(p__157823,m){
var map__157824 = p__157823;
var map__157824__$1 = cljs.core.__destructure_map(map__157824);
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__157824__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
if(com.wsscode.pathom3.format.eql.union_children_QMARK_(ast)){
var merged_children = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"children","children",-940561982)),(function (){var G__157825 = ast;
var G__157825__$1 = (((G__157825 == null))?null:new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__157825));
var G__157825__$2 = (((G__157825__$1 == null))?null:cljs.core.first(G__157825__$1));
if((G__157825__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__157825__$2);
}
})());
...
com.wsscode.pathom3.format.eql.index_ast = (function com$wsscode$pathom3$format$eql$index_ast(p__157826){
var map__157827 = p__157826;
var map__157827__$1 = cljs.core.__destructure_map(map__157827);
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__157827__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
com.wsscode.pathom3.format.eql.map_select_entry = (function com$wsscode$pathom3$format$eql$map_select_entry(env,source,p__157830){
var map__157831 = p__157830;
var map__157831__$1 = cljs.core.__destructure_map(map__157831);
var ast = map__157831__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__157831__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__157831__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__157831__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var ast__$2 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(ast__$1,new cljs.core.Keyword(null,"children","children",-940561982),(function (p1__157828_SHARP_){
var or__4223__auto__ = p1__157828_SHARP_;
...
})())?val:((cljs.core.map_QMARK_(val))?(com.wsscode.pathom3.format.eql.map_select_ast.cljs$core$IFn$_invoke$arity$3 ? com.wsscode.pathom3.format.eql.map_select_ast.cljs$core$IFn$_invoke$arity$3(env,val,ast__$2) : com.wsscode.pathom3.format.eql.map_select_ast.call(null,env,val,ast__$2)):((com.wsscode.misc.coll.collection_QMARK_(val))?cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.empty(val),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__157829_SHARP_){
return (com.wsscode.pathom3.format.eql.map_select_ast.cljs$core$IFn$_invoke$arity$3 ? com.wsscode.pathom3.format.eql.map_select_ast.cljs$core$IFn$_invoke$arity$3(env,p1__157829_SHARP_,ast__$2) : com.wsscode.pathom3.format.eql.map_select_ast.call(null,env,p1__157829_SHARP_,ast__$2));
})),(function (){var G__157834 = val;
if(com.wsscode.misc.coll.coll_append_at_head_QMARK_(val)){
return cljs.core.reverse(G__157834);
} else {
return G__157834;
}
})()):val
 ...
 */
com.wsscode.pathom3.format.eql.ast_contains_wildcard_QMARK_ = (function com$wsscode$pathom3$format$eql$ast_contains_wildcard_QMARK_(p__157835){
var map__157836 = p__157835;
var map__157836__$1 = cljs.core.__destructure_map(map__157836);
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__157836__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.wsscode.pathom3.format.eql.map_select_ast = (function com$wsscode$pathom3$format$eql$map_select_ast(p__157846,source,ast){
var map__157847 = p__157846;
var map__157847__$1 = cljs.core.__destructure_map(map__157847);
var env = map__157847__$1;
var map_select_include = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__157847__$1,new cljs.core.Keyword("com.wsscode.pathom3.format.eql","map-select-include","com.wsscode.pathom3.format.eql/map-select-include",-1328680889));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(start,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__157842_SHARP_){
return com.wsscode.pathom3.plugin.run_with_plugins.cljs$core$IFn$_invoke$arity$6(env,new cljs.core.Keyword("com.wsscode.pathom3.format.eql","wrap-map-select-entry","com.wsscode.pathom3.format.eql/wrap-map-select-entry",901874620),com.wsscode.pathom3.format.eql.map_select_entry,env,source,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__157842_SHARP_,new cljs.core.Keyword(null,"parent-ast","parent-ast",-1730341901),ast));
})),(function (){var G__157852 = (function (){var G__157853 = new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(com.wsscode.pathom3.format.eql.pick_union_entry(ast,source));
if(cljs.core.truth_(map_select_include)){
return com.wsscode.pathom3.format.eql.include_extra_attrs(G__157853,map_select_include);
} else {
return G__157853;
}
})();
if(com.wsscode.pathom3.format.eql.ast_contains_wildcard_QMARK_(ast)){
return com.wsscode.pathom3.format.eql.extend_ast_with_wildcard(source,G__157852);
} else {
return G__157852;
}
})());
...
return cljs.core.vec(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str,(function (p1__157855_SHARP_){
if(cljs.core.map_QMARK_(p1__157855_SHARP_)){
return cljs.core.ffirst(p1__157855_SHARP_);
} else {
return p1__157855_SHARP_;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(children,(function (){var G__157858 = ast;
if(cljs.core.truth_(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(ast))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__157858,new cljs.core.Keyword(null,"children","children",-940561982),com.wsscode.pathom3.format.eql.map_children__GT_children);
} else {
return G__157858;
}
})());
...
var idx_SINGLEQUOTE_ = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx__$1,p__157859){
var map__157860 = p__157859;
var map__157860__$1 = cljs.core.__destructure_map(map__157860);
var node = map__157860__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__157860__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2((function (){var G__157861 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ast2,ast1], 0));
var G__157861__$1 = ((cljs.core.seq(idx_SINGLEQUOTE_))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__157861,new cljs.core.Keyword(null,"children","children",-940561982),com.wsscode.pathom3.format.eql.map_children__GT_children(idx_SINGLEQUOTE_)):G__157861);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__157861__$1,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"join","join",-758861890));
} else {
return G__157861__$1;
}
