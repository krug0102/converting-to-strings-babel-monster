...
var G__159065 = arguments.length;
switch (G__159065) {
case 1:
...
(malli.impl.util.SchemaError.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k159070,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__159074 = k159070;
var G__159074__$1 = (((G__159074 instanceof cljs.core.Keyword))?G__159074.fqn:null);
switch (G__159074__$1) {
case "path":
return self__.path;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k159070,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__159077){
var vec__159078 = p__159077;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__159078,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__159078,(1),null);
...
(malli.impl.util.SchemaError.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__159069){
var self__ = this;
var G__159069__$1 = this;
return (new cljs.core.RecordIter((0),G__159069__$1,6,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Keyword(null,"schema","schema",-1582001791),new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"message","message",-406056002)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(malli.impl.util.SchemaError.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this159071,other159072){
var self__ = this;
var this159071__$1 = this;
return (((!((other159072 == null)))) && ((((this159071__$1.constructor === other159072.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this159071__$1.path,other159072.path)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this159071__$1.in,other159072.in)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this159071__$1.schema,other159072.schema)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this159071__$1.value,other159072.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this159071__$1.type,other159072.type)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this159071__$1.message,other159072.message)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this159071__$1.__extmap,other159072.__extmap)))))))))))))))));
}));
...
(malli.impl.util.SchemaError.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k159070){
var self__ = this;
var this__4479__auto____$1 = this;
var G__159086 = k159070;
var G__159086__$1 = (((G__159086 instanceof cljs.core.Keyword))?G__159086.fqn:null);
switch (G__159086__$1) {
case "path":
case "in":
case "schema":
case "value":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k159070);

}
}));

(malli.impl.util.SchemaError.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__159069){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__159087 = cljs.core.keyword_identical_QMARK_;
var expr__159088 = k__4481__auto__;
if(cljs.core.truth_((pred__159087.cljs$core$IFn$_invoke$arity$2 ? pred__159087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"path","path",-188191168),expr__159088) : pred__159087.call(null,new cljs.core.Keyword(null,"path","path",-188191168),expr__159088)))){
return (new malli.impl.util.SchemaError(G__159069,self__.in$,self__.schema,self__.value,self__.type,self__.message,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__159087.cljs$core$IFn$_invoke$arity$2 ? pred__159087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"in","in",-1531184865),expr__159088) : pred__159087.call(null,new cljs.core.Keyword(null,"in","in",-1531184865),expr__159088)))){
return (new malli.impl.util.SchemaError(self__.path,G__159069,self__.schema,self__.value,self__.type,self__.message,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__159087.cljs$core$IFn$_invoke$arity$2 ? pred__159087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"schema","schema",-1582001791),expr__159088) : pred__159087.call(null,new cljs.core.Keyword(null,"schema","schema",-1582001791),expr__159088)))){
return (new malli.impl.util.SchemaError(self__.path,self__.in$,G__159069,self__.value,self__.type,self__.message,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__159087.cljs$core$IFn$_invoke$arity$2 ? pred__159087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__159088) : pred__159087.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__159088)))){
return (new malli.impl.util.SchemaError(self__.path,self__.in$,self__.schema,G__159069,self__.type,self__.message,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__159087.cljs$core$IFn$_invoke$arity$2 ? pred__159087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348),expr__159088) : pred__159087.call(null,new cljs.core.Keyword(null,"type","type",1174270348),expr__159088)))){
return (new malli.impl.util.SchemaError(self__.path,self__.in$,self__.schema,self__.value,G__159069,self__.message,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__159087.cljs$core$IFn$_invoke$arity$2 ? pred__159087.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"message","message",-406056002),expr__159088) : pred__159087.call(null,new cljs.core.Keyword(null,"message","message",-406056002),expr__159088)))){
return (new malli.impl.util.SchemaError(self__.path,self__.in$,self__.schema,self__.value,self__.type,G__159069,self__.__meta,self__.__extmap,null));
} else {
return (new malli.impl.util.SchemaError(self__.path,self__.in$,self__.schema,self__.value,self__.type,self__.message,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__159069),null));
}
}
}
}
...
(malli.impl.util.SchemaError.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__159069){
var self__ = this;
var this__4471__auto____$1 = this;
return (new malli.impl.util.SchemaError(self__.path,self__.in$,self__.schema,self__.value,self__.type,self__.message,G__159069,self__.__extmap,self__.__hash));
}));
 ...
 */
malli.impl.util.map__GT_SchemaError = (function malli$impl$util$map__GT_SchemaError(G__159073){
var extmap__4512__auto__ = (function (){var G__159090 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__159073,new cljs.core.Keyword(null,"path","path",-188191168),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Keyword(null,"schema","schema",-1582001791),new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"message","message",-406056002)], 0));
if(cljs.core.record_QMARK_(G__159073)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__159090);
} else {
return G__159090;
}
})();
return (new malli.impl.util.SchemaError(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(G__159073),new cljs.core.Keyword(null,"in","in",-1531184865).cljs$core$IFn$_invoke$arity$1(G__159073),new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(G__159073),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__159073),new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__159073),new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(G__159073),null,cljs.core.not_empty(extmap__4512__auto__),null));
});

malli.impl.util._error = (function malli$impl$util$_error(var_args){
var G__159092 = arguments.length;
switch (G__159092) {
case 4:
