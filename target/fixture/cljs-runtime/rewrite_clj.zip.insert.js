...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(insert_fn,zloc,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((cljs.core.truth_((function (){var and__4221__auto__ = next_node;
...
return rewrite_clj.zip.insert.insert((function (p1__152024_SHARP_){
var G__152025 = p1__152024_SHARP_;
var G__152025__$1 = (((G__152025 == null))?null:rewrite_clj.custom_zipper.core.down(G__152025));
if((G__152025__$1 == null)){
return null;
} else {
return rewrite_clj.custom_zipper.core.rightmost(G__152025__$1);
}
