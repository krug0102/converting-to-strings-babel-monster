...
var G__150161 = o;
goog.object.set(G__150161,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__150366__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__150366 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__150367__i = 0, G__150367__a = new Array(arguments.length -  0);
while (G__150367__i < G__150367__a.length) {G__150367__a[G__150367__i] = arguments[G__150367__i + 0]; ++G__150367__i;}
  args = new cljs.core.IndexedSeq(G__150367__a,0,null);
} 
return G__150366__delegate.call(this,args);};
G__150366.cljs$lang$maxFixedArity = 0;
G__150366.cljs$lang$applyTo = (function (arglist__150369){
var args = cljs.core.seq(arglist__150369);
return G__150366__delegate(args);
});
G__150366.cljs$core$IFn$_invoke$arity$variadic = G__150366__delegate;
return G__150366;
})()
;
} else {
...
var G__150165 = o;
goog.object.set(G__150165,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__150372__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__150372 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__150373__i = 0, G__150373__a = new Array(arguments.length -  0);
while (G__150373__i < G__150373__a.length) {G__150373__a[G__150373__i] = arguments[G__150373__i + 0]; ++G__150373__i;}
  args = new cljs.core.IndexedSeq(G__150373__a,0,null);
} 
return G__150372__delegate.call(this,args);};
G__150372.cljs$lang$maxFixedArity = 0;
G__150372.cljs$lang$applyTo = (function (arglist__150374){
var args = cljs.core.seq(arglist__150374);
return G__150372__delegate(args);
});
G__150372.cljs$core$IFn$_invoke$arity$variadic = G__150372__delegate;
return G__150372;
})()
;
} else {
...
var G__150194 = props;
var G__150194__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__150194,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__150194);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__150194__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__150194__$1;
}
});
reagent.impl.template.convert_props = (function reagent$impl$template$convert_props(props,id_class){
var class$ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
var props__$1 = reagent.impl.template.set_id_class((function (){var G__150199 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__150199,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__150199;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__150207){
var map__150208 = p__150207;
var map__150208__$1 = cljs.core.__destructure_map(map__150208);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__150208__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__150218_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__150218_SHARP_);
}));
} else {
return null;
}
...
var vec__150225 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150225,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150225,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150225,(2),null);
...
var temp__5757__auto___150394 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___150394 == null)){
} else {
var key_150396 = temp__5757__auto___150394;
(jsprops.key = key_150396);
}
...
var temp__5757__auto___150399 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___150399 == null)){
} else {
var key_150400 = temp__5757__auto___150399;
(jsprops.key = key_150400);
}

return (reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4 ? reagent.impl.template.make_element.cljs$core$IFn$_invoke$arity$4(argv,shadow.js.shim.module$react.Fragment,jsprops,first_child) : reagent.impl.template.make_element.call(null,argv,shadow.js.shim.module$react.Fragment,jsprops,first_child));
});
...
var G__150235 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__150235) : reagent.impl.template.as_element.call(null,G__150235));
} else {
var temp__5757__auto___150404 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___150404 == null)){
} else {
var key_150405 = temp__5757__auto___150404;
(jsprops.key = key_150405);
}
...
var G__150239 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__150239)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__150239)){
return x;
} else {
...
var len__4829__auto___150406 = arguments.length;
var i__4830__auto___150407 = (0);
while(true){
if((i__4830__auto___150407 < len__4829__auto___150406)){
args__4835__auto__.push((arguments[i__4830__auto___150407]));

var G__150408 = (i__4830__auto___150407 + (1));
i__4830__auto___150407 = G__150408;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq150240){
var G__150241 = cljs.core.first(seq150240);
var seq150240__$1 = cljs.core.next(seq150240);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__150241,seq150240__$1);
}));
...
break;
default:
var G__150414 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__150414;
continue;
...
var ctx = ({});
var vec__150285 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150285,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__150285,(1),null);
...
var G__150349 = (cljs.core.count(argv) - first_child);
switch (G__150349) {
case (0):
...
break;
case (1):
return shadow.js.shim.module$react.createElement(component,jsprops,reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null)));
