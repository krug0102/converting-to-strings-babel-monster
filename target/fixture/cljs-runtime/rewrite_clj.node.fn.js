...
var sym_seq = (function (){var iter__4622__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__151475(s__151476){
return (new cljs.core.LazySeq(null,(function (){
var s__151476__$1 = s__151476;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__151476__$1);
if(temp__5753__auto__){
var s__151476__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__151476__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__151476__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__151478 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__151477 = (0);
while(true){
if((i__151477 < size__4621__auto__)){
var i = cljs.core._nth(c__4620__auto__,i__151477);
...
cljs.core.chunk_append(b__151478,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__151515 = (i__151477 + (1));
i__151477 = G__151515;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__151478),rewrite_clj$node$fn$fn_walk_$_iter__151475(cljs.core.chunk_rest(s__151476__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__151478),null);
}
} else {
var i = cljs.core.first(s__151476__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__151475(cljs.core.rest(s__151476__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__151474_SHARP_){
var or__4223__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__151474_SHARP_);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return p1__151474_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k151484,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__151488 = k151484;
var G__151488__$1 = (((G__151488 instanceof cljs.core.Keyword))?G__151488.fqn:null);
switch (G__151488__$1) {
case "children":
return self__.children;

break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k151484,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__151491){
var vec__151493 = p__151491;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151493,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151493,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__151483){
var self__ = this;
var G__151483__$1 = this;
return (new cljs.core.RecordIter((0),G__151483__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this151485,other151486){
var self__ = this;
var this151485__$1 = this;
return (((!((other151486 == null)))) && ((((this151485__$1.constructor === other151486.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151485__$1.children,other151486.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this151485__$1.__extmap,other151486.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k151484){
var self__ = this;
var this__4479__auto____$1 = this;
var G__151510 = k151484;
var G__151510__$1 = (((G__151510 instanceof cljs.core.Keyword))?G__151510.fqn:null);
switch (G__151510__$1) {
case "children":
return true;

break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k151484);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__151483){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__151511 = cljs.core.keyword_identical_QMARK_;
var expr__151512 = k__4481__auto__;
if(cljs.core.truth_((pred__151511.cljs$core$IFn$_invoke$arity$2 ? pred__151511.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__151512) : pred__151511.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__151512)))){
return (new rewrite_clj.node.fn.FnNode(G__151483,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__151483),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__151483){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__151483,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__151487){
var extmap__4512__auto__ = (function (){var G__151514 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__151487,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__151487)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__151514);
} else {
return G__151514;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__151487),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
