...
var G__151861 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__151862 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__151861;
lines = G__151862;
continue;
} else {
...
var comma_151863 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_151864 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_151863),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__151852){
var vec__151853 = p__151852;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151853,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__151853,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_151864,rewrite_clj.node.protocols.coerce(v),comma_151863);
...
goog.object.set(rewrite_clj.node.protocols.coerce,"string",(function (v){
return rewrite_clj.node.stringz.string_node(rewrite_clj.node.coercer.split_to_lines(v));
}));
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"_",true);

goog.object.set(rewrite_clj.node.protocols.coerce,"_",(function (v){
...
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"null",true);

goog.object.set(rewrite_clj.node.protocols.coerce,"null",(function (v){
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__151856 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__151856) : f.call(null,G__151856));
})(),sq);
});
