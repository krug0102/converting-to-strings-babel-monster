...
if((c === "\n")){
var G__151875 = escape_QMARK_;
var G__151876 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__151875;
lines = G__151876;
continue;
} else {
buf.append(c);

var G__151877 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__151878 = lines;
escape_QMARK_ = G__151877;
lines = G__151878;
continue;
