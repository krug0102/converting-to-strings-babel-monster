...
var schema$spec$core$CoreSpec$subschemas$dyn_47737 = (function (this$){
...
return schema$spec$core$CoreSpec$subschemas$dyn_47737(this$);
}
});

var schema$spec$core$CoreSpec$checker$dyn_47739 = (function (this$,params){
var x__4521__auto__ = (((this$ == null))?null:this$);
...
return schema$spec$core$CoreSpec$checker$dyn_47739(this$,params);
}
});
...
}catch (e47708){if((e47708 instanceof Object)){
var e_SHARP_ = e47708;
...
var G__47709 = schema.utils.value_name(x);
return (err_f.cljs$core$IFn$_invoke$arity$1 ? err_f.cljs$core$IFn$_invoke$arity$1(G__47709) : err_f.call(null,G__47709));
}),null)),reason));
} else {
return null;
}
...
var G__47729 = (new cljs.core.Delay((function (){
var fexpr__47730 = cljs.core.deref(cache);
return (fexpr__47730.cljs$core$IFn$_invoke$arity$1 ? fexpr__47730.cljs$core$IFn$_invoke$arity$1(cache_key) : fexpr__47730.call(null,cache_key));
}),null));
return (wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1 ? wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1(G__47729) : wrap_recursive_delay.call(null,G__47729));
} else {
return w;
}
} else {
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__47731,p__47732){
var map__47733 = p__47731;
var map__47733__$1 = cljs.core.__destructure_map(map__47733);
var schema__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47733__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47733__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__47734 = p__47732;
var map__47734__$1 = cljs.core.__destructure_map(map__47734);
var params = map__47734__$1;
var subschema_checker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47734__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47734__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache(cache,schema__$1,(function (d){
return (function (x){
var fexpr__47735 = cljs.core.deref(d);
return (fexpr__47735.cljs$core$IFn$_invoke$arity$1 ? fexpr__47735.cljs$core$IFn$_invoke$arity$1(x) : fexpr__47735.call(null,x));
});
}),(function (){
