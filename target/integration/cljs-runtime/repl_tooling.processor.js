...
var or__4223__auto__ = (function (){var G__53937 = cljs.core.first(vector_of_keywords);
return (repl_tooling.processor.spec_ref.cljs$core$IFn$_invoke$arity$1 ? repl_tooling.processor.spec_ref.cljs$core$IFn$_invoke$arity$1(G__53937) : repl_tooling.processor.spec_ref.call(null,G__53937));
})();
...
var or__4223__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53936_SHARP_){
return (!((p1__53936_SHARP_ == null)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53935_SHARP_){
return (repl_tooling.processor.spec_ref.cljs$core$IFn$_invoke$arity$1 ? repl_tooling.processor.spec_ref.cljs$core$IFn$_invoke$arity$1(p1__53935_SHARP_) : repl_tooling.processor.spec_ref.call(null,p1__53935_SHARP_));
...
repl_tooling.processor.has_alpha_nil_QMARK_ = (function repl_tooling$processor$has_alpha_nil_QMARK_(p__53938){
...
return sp.selected_any_QMARK_(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [sp.ALL,sp.if_path(cljs.core.seqable_QMARK_,sp.ALL,sp.STAY),(function (p1__53940_SHARP_){
return clojure.string.starts_with_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53940_SHARP_),repl_tooling.processor.BABEL_NS);
})], null),p);
});
...
var or__4223__auto__ = (function (){var G__53941 = (((typeof p !== 'undefined'))?(new cljs.core.Var((function (){
return p;
...
return (repl_tooling.processor.macro_predicates.cljs$core$IFn$_invoke$arity$1 ? repl_tooling.processor.macro_predicates.cljs$core$IFn$_invoke$arity$1(G__53941) : repl_tooling.processor.macro_predicates.call(null,G__53941));
})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var G__53942 = new cljs.core.Var(function(){return cljs.core.sequential_QMARK_;},new cljs.core.Symbol("cljs.core","sequential?","cljs.core/sequential?",1777854658,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[new cljs.core.Symbol(null,"cljs.core","cljs.core",770546058,null),new cljs.core.Symbol(null,"sequential?","sequential?",1102351463,null),"cljs/core.cljs",(18),(1),(2159),(2159),cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"x","x",-555367584,null)], null)),"Returns true if coll satisfies ISequential",(cljs.core.truth_(cljs.core.sequential_QMARK_)?cljs.core.sequential_QMARK_.cljs$lang$test:null)]));
return (repl_tooling.processor.macro_predicates.cljs$core$IFn$_invoke$arity$1 ? repl_tooling.processor.macro_predicates.cljs$core$IFn$_invoke$arity$1(G__53942) : repl_tooling.processor.macro_predicates.call(null,G__53942));
} else {
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(" or",cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53947_SHARP_){
return (cljs.core.first(p1__53947_SHARP_) >= (0));
}),cljs.core.sort.cljs$core$IFn$_invoke$arity$2((function (p1__53945_SHARP_,p2__53946_SHARP_){
return (cljs.core.first(p1__53945_SHARP_) < cljs.core.first(p2__53946_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53944_SHARP_){
return repl_tooling.processor.predicate_name(p1__53944_SHARP_);
}),cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pred","pred",1927423397),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53943_SHARP_){
return (new cljs.core.Keyword(null,"reason","reason",-2070751759).cljs$core$IFn$_invoke$arity$1(p1__53943_SHARP_) == null);
}),probs)))))))));
});
/**
...
return (((!(cljs.core.empty_QMARK_(via_lasts)))) && (cljs.core.every_QMARK_((function (p1__53948_SHARP_){
var or__4223__auto__ = cljs.core.re_find(/param-list/,p1__53948_SHARP_);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return cljs.core.re_find(/param+body/,p1__53948_SHARP_);
}
}),via_lasts)));
});
/**
...
var vec__53949 = cljs.core.re_matches(/Invalid signature \"(.*)\" should be a (.*)/,cause);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53949,(0),null);
var what = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53949,(1),null);
var should_be = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53949,(2),null);
