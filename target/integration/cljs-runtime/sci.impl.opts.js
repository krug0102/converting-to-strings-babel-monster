...
var len__4829__auto___77738 = arguments.length;
var i__4830__auto___77739 = (0);
while(true){
if((i__4830__auto___77739 < len__4829__auto___77738)){
args__4835__auto__.push((arguments[i__4830__auto___77739]));

var G__77740 = (i__4830__auto___77739 + (1));
i__4830__auto___77739 = G__77740;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq77730){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq77730));
}));
...
var G__77741 = null;
var G__77741__1 = (function (msg){
return (new Error(msg));
});
var G__77741__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__77741__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__77741 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__77741__1.call(this,msg);
case 2:
return G__77741__2.call(this,msg,filename);
case 3:
return G__77741__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__77741.cljs$core$IFn$_invoke$arity$1 = G__77741__1;
G__77741.cljs$core$IFn$_invoke$arity$2 = G__77741__2;
G__77741.cljs$core$IFn$_invoke$arity$3 = G__77741__3;
return G__77741;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__77731_SHARP_){
return (new cljs.core.Delay(p1__77731_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__77732_SHARP_){
return (new goog.string.StringBuffer(p1__77732_SHARP_));
})], null)], null);
...
var vec__77733 = temp__5751__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77733,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77733,(1),null);
var G__77742 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__77743 = cljs.core.rest(kvs);
class__GT_opts = G__77742;
kvs = G__77743;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__77736){
var map__77737 = p__77736;
var map__77737__$1 = cljs.core.__destructure_map(map__77737);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var preset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"preset","preset",777387345));
var realize_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var uberscript = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"uberscript","uberscript",701571092));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77737__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
