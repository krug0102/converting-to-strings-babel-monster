...
repl_tooling.commands_to_repl.all_cmds.eval_range = (function repl_tooling$commands_to_repl$all_cmds$eval_range(state,p__146812,opts,function$){
var map__146813 = p__146812;
var map__146813__$1 = cljs.core.__destructure_map(map__146813);
var data = map__146813__$1;
var contents = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146813__$1,new cljs.core.Keyword(null,"contents","contents",-1567174023));
var range = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146813__$1,new cljs.core.Keyword(null,"range","range",1639692286));
var vec__146815 = range;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146815,(0),null);
var vec__146818 = (function$.cljs$core$IFn$_invoke$arity$2 ? function$.cljs$core$IFn$_invoke$arity$2(contents,start) : function$.call(null,contents,start));
var eval_range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146818,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146818,(1),null);
if(cljs.core.truth_(eval_range)){
var vec__146823 = repl_tooling.editor_helpers.ns_range_for(contents,cljs.core.first(eval_range));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146823,(0),null);
var namespace = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146823,(1),null);
...
return promesa.protocols._bind(null,(function (___31820__auto__){
return promesa.protocols._bind(data,(function (p__146838){
var map__146840 = p__146838;
var map__146840__$1 = cljs.core.__destructure_map(map__146840);
var d = map__146840__$1;
var range = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146840__$1,new cljs.core.Keyword(null,"range","range",1639692286));
return promesa.protocols._bind(null,(function (___31810__auto__){
...
repl_tooling.commands_to_repl.all_cmds.all = (function repl_tooling$commands_to_repl$all_cmds$all(state,p__146845,repl_kind){
var map__146847 = p__146845;
var map__146847__$1 = cljs.core.__destructure_map(map__146847);
var opts = map__146847__$1;
var editor_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146847__$1,new cljs.core.Keyword(null,"editor-data","editor-data",-2084300305));
return promesa.protocols._bind(null,(function (___31820__auto__){
...
})], null)], 0)):G__146850__$1);
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__146850__$2,orchard_cmds], 0));
...
return promesa.protocols._bind(null,(function (___31820__auto__){
return promesa.protocols._bind(repl_tooling.editor_integration.commands.run_callback_BANG_(editor_state,new cljs.core.Keyword(null,"editor-data","editor-data",-2084300305)),(function (p__146860){
var map__146861 = p__146860;
var map__146861__$1 = cljs.core.__destructure_map(map__146861);
var contents = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146861__$1,new cljs.core.Keyword(null,"contents","contents",-1567174023));
var range = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146861__$1,new cljs.core.Keyword(null,"range","range",1639692286));
var filename = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146861__$1,new cljs.core.Keyword(null,"filename","filename",-1428840783));
return promesa.protocols._bind((function (){var G__146863 = contents;
var G__146864 = cljs.core.first(range);
return (repl_tooling.editor_helpers.current_var.cljs$core$IFn$_invoke$arity$2 ? repl_tooling.editor_helpers.current_var.cljs$core$IFn$_invoke$arity$2(G__146863,G__146864) : repl_tooling.editor_helpers.current_var.call(null,G__146863,G__146864));
})(),(function (p__146866){
var vec__146868 = p__146866;
var range__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146868,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146868,(1),null);
...
var G__146876 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"doc-for-var","doc-for-var",376145016),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),"Documentation for current var",new cljs.core.Keyword(null,"description","description",-1428560544),"Shows documentation for the current var under cursor",new cljs.core.Keyword(null,"command","command",-894540724),(function (){
