...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__84025,new cljs.core.Keyword("com.wsscode.pathom3.connect.runner","attribute-errors","com.wsscode.pathom3.connect.runner/attribute-errors",723532527),errors);
} else {
return G__84025;
}
} else {
...
var G__84027 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(env,new cljs.core.Keyword("com.wsscode.pathom3.format.eql","map-select-include","com.wsscode.pathom3.format.eql/map-select-include",-1328680889),com.wsscode.misc.coll.sconj,new cljs.core.Keyword("com.wsscode.pathom3.connect.runner","attribute-errors","com.wsscode.pathom3.connect.runner/attribute-errors",723532527));
var G__84028 = ast;
return (process.cljs$core$IFn$_invoke$arity$2 ? process.cljs$core$IFn$_invoke$arity$2(G__84027,G__84028) : process.call(null,G__84027,G__84028));
});
...
return (function com$wsscode$pathom3$connect$built_in$plugins$mutation_resolve_params_external_$_mutation_resolve_params_internal(env,p__84029){
var map__84030 = p__84029;
var map__84030__$1 = cljs.core.__destructure_map(map__84030);
var ast = map__84030__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84030__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var map__84031 = com.wsscode.pathom3.connect.indexes.mutation_config(env,key);
var map__84031__$1 = cljs.core.__destructure_map(map__84031);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84031__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.operation","params","com.wsscode.pathom3.connect.operation/params",-1389779339));
...
var G__84032 = env;
var G__84033 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ast,new cljs.core.Keyword(null,"params","params",710516235),params_SINGLEQUOTE_);
return (mutate.cljs$core$IFn$_invoke$arity$2 ? mutate.cljs$core$IFn$_invoke$arity$2(G__84032,G__84033) : mutate.call(null,G__84032,G__84033));
}));
} else {
var params_SINGLEQUOTE_ = r__82170__auto__;
var G__84035 = env;
var G__84036 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ast,new cljs.core.Keyword(null,"params","params",710516235),params_SINGLEQUOTE_);
return (mutate.cljs$core$IFn$_invoke$arity$2 ? mutate.cljs$core$IFn$_invoke$arity$2(G__84035,G__84036) : mutate.call(null,G__84035,G__84036));
}
});
})], null)], 0));
