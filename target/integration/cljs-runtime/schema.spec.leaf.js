...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k47751,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k47751,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__47756){
var vec__47757 = p__47756;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47757,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47757,(1),null);
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__47750){
var self__ = this;
var G__47750__$1 = this;
return (new cljs.core.RecordIter((0),G__47750__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this47752,other47753){
var self__ = this;
var this47752__$1 = this;
return (((!((other47753 == null)))) && ((((this47752__$1.constructor === other47753.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47752__$1.pre,other47753.pre)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47752__$1.__extmap,other47753.__extmap)))))));
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k47751){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k47751);

}
}));

(schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__47750){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__47778 = cljs.core.keyword_identical_QMARK_;
var expr__47779 = k__4481__auto__;
if(cljs.core.truth_((pred__47778.cljs$core$IFn$_invoke$arity$2 ? pred__47778.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__47779) : pred__47778.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__47779)))){
return (new schema.spec.leaf.LeafSpec(G__47750,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__47750),null));
}
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__47750){
var self__ = this;
var this__4471__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__47750,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__47754){
var extmap__4512__auto__ = (function (){var G__47792 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__47754,new cljs.core.Keyword(null,"pre","pre",2118456869));
if(cljs.core.record_QMARK_(G__47754)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__47792);
} else {
return G__47792;
}
})();
return (new schema.spec.leaf.LeafSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__47754),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
