...
return promesa.protocols._bind(new cljs.core.Keyword("editor","callbacks","editor/callbacks",1179124831).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(editor_state)),(function (p__146481){
var map__146482 = p__146481;
var map__146482__$1 = cljs.core.__destructure_map(map__146482);
var on_start_eval = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146482__$1,new cljs.core.Keyword(null,"on-start-eval","on-start-eval",-560475418));
var on_eval = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146482__$1,new cljs.core.Keyword(null,"on-eval","on-eval",-1349336659));
var editor_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146482__$1,new cljs.core.Keyword(null,"editor-data","editor-data",-2084300305));
var get_config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146482__$1,new cljs.core.Keyword(null,"get-config","get-config",1800808901));
return promesa.protocols._bind((editor_data.cljs$core$IFn$_invoke$arity$0 ? editor_data.cljs$core$IFn$_invoke$arity$0() : editor_data.call(null)),(function (p__146483){
var map__146484 = p__146483;
var map__146484__$1 = cljs.core.__destructure_map(map__146484);
var ed = map__146484__$1;
var contents = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146484__$1,new cljs.core.Keyword(null,"contents","contents",-1567174023));
var range = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146484__$1,new cljs.core.Keyword(null,"range","range",1639692286));
var filename = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__146484__$1,new cljs.core.Keyword(null,"filename","filename",-1428840783));
...
return promesa.protocols._bind((repl_tooling.editor_helpers.current_var.cljs$core$IFn$_invoke$arity$2 ? repl_tooling.editor_helpers.current_var.cljs$core$IFn$_invoke$arity$2(contents,start) : repl_tooling.editor_helpers.current_var.call(null,contents,start)),(function (p__146485){
var vec__146486 = p__146485;
var range__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146486,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146486,(1),null);
...
return promesa.protocols._bind((function (){var G__146489 = splitted;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(splitted))){
return cljs.core.cons("user",G__146489);
} else {
return G__146489;
}
})(),(function (p__146490){
var vec__146491 = p__146490;
var ns_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146491,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146491,(1),null);
...
return promesa.protocols._bind(start,(function (p__146494){
var vec__146495 = p__146494;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146495,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146495,(1),null);
...
return promesa.protocols._promise(repl_tooling.eval.evaluate(repl,cmd,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"ignore","ignore",-1631542033),true,new cljs.core.Keyword(null,"row","row",-570139521),row,new cljs.core.Keyword(null,"col","col",-1959363084),col], null),(function (p1__146480_SHARP_){
var G__146498 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(params,new cljs.core.Keyword(null,"result","result",1415092211),p1__146480_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"repl","repl",-35398667),repl], 0));
return (on_eval.cljs$core$IFn$_invoke$arity$1 ? on_eval.cljs$core$IFn$_invoke$arity$1(G__146498) : on_eval.call(null,G__146498));
})));
}));
}));
}));
...
return promesa.protocols._bind((function (){var G__146769 = s;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(s),(1))){
return cljs.core.cons("",G__146769);
} else {
return G__146769;
}
})(),(function (p__146772){
var vec__146773 = p__146772;
var ns_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146773,(0),null);
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__146773,(1),null);
