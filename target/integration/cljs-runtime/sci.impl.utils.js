...
var G__68997 = x;
var G__68997__$1 = (((G__68997 == null))?null:cljs.core.meta(G__68997));
if((G__68997__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl","op","sci.impl/op",950953978).cljs$core$IFn$_invoke$arity$1(G__68997__$1);
}
});
...
var map__69029 = cljs.core.meta(iobj);
var map__69029__$1 = cljs.core.__destructure_map(map__69029);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69029__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69029__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var map__69039_69108 = cljs.core.meta(node);
var map__69039_69109__$1 = cljs.core.__destructure_map(map__69039_69108);
var line_69110 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69039_69109__$1,new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(ctx));
var column_69111 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69039_69109__$1,new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(ctx));
if(cljs.core.truth_((function (){var and__4221__auto__ = line_69110;
if(cljs.core.truth_(and__4221__auto__)){
return column_69111;
} else {
return and__4221__auto__;
...
var m_69115 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(ex_msg),(cljs.core.truth_(ex_msg)?" ":null),"[at ",(function (){var temp__5753__auto__ = cljs.core.deref(sci.impl.vars.current_file);
if(cljs.core.truth_(temp__5753__auto__)){
var v = temp__5753__auto__;
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),", "].join('');
} else {
...
})(),"line ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(line_69110),", column ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(column_69111),"]"].join('');
var new_exception_69116 = (function (){var d = cljs.core.ex_data(e);
return cljs.core.ex_info.cljs$core$IFn$_invoke$arity$3(m_69115,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line_69110,new cljs.core.Keyword(null,"column","column",2078222095),column_69111,new cljs.core.Keyword(null,"message","message",-406056002),m_69115], null),d], 0)),e);
})();
throw new_exception_69116;
} else {
throw e;
}
}
...
var len__4829__auto___69122 = arguments.length;
var i__4830__auto___69123 = (0);
while(true){
if((i__4830__auto___69123 < len__4829__auto___69122)){
args__4835__auto__.push((arguments[i__4830__auto___69123]));

var G__69124 = (i__4830__auto___69123 + (1));
i__4830__auto___69123 = G__69124;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq69048){
var G__69049 = cljs.core.first(seq69048);
var seq69048__$1 = cljs.core.next(seq69048);
var G__69050 = cljs.core.first(seq69048__$1);
var seq69048__$2 = cljs.core.next(seq69048__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69049,G__69050,seq69048__$2);
}));
...
var G__69067 = cljs.core.namespace(sym);
switch (G__69067) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__69073 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__69073) : inner.call(null,G__69073));
})(),(function (){var G__69074 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__69074) : inner.call(null,G__69074));
})(),null));
} else {
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__69088_SHARP_){
return f(p1__69088_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__69092 = pred;
var G__69093 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__69092,G__69093) : sci.impl.utils.split_when.call(null,G__69092,G__69093));
})());
} else {
return null;
}
