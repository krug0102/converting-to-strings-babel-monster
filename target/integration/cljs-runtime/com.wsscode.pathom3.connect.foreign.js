...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__83414){
var vec__83415 = p__83414;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83415,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83415,(1),null);
...
com.wsscode.pathom3.connect.foreign.compute_foreign_input = (function com$wsscode$pathom3$connect$foreign$compute_foreign_input(p__83418){
var map__83419 = p__83418;
var map__83419__$1 = cljs.core.__destructure_map(map__83419);
var env = map__83419__$1;
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83419__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.planner","node","com.wsscode.pathom3.connect.planner/node",325156565));
...
com.wsscode.pathom3.connect.foreign.compute_foreign_query = (function com$wsscode$pathom3$connect$foreign$compute_foreign_query(p__83420){
var map__83421 = p__83420;
var map__83421__$1 = cljs.core.__destructure_map(map__83421);
var env = map__83421__$1;
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83421__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.planner","node","com.wsscode.pathom3.connect.planner/node",325156565));
...
com.wsscode.pathom3.connect.foreign.internalize_foreign_errors = (function com$wsscode$pathom3$connect$foreign$internalize_foreign_errors(p__83430,errors){
var map__83431 = p__83430;
var map__83431__$1 = cljs.core.__destructure_map(map__83431);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83431__$1,new cljs.core.Keyword("com.wsscode.pathom3.path","path","com.wsscode.pathom3.path/path",1029673558));
var join_node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83431__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.foreign","join-node","com.wsscode.pathom3.connect.foreign/join-node",1596326140));
return com.wsscode.misc.coll.map_keys((function (p1__83429_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.pop(path),(function (){var G__83432 = p1__83429_SHARP_;
if(cljs.core.truth_(join_node)){
return cljs.core.next(G__83432);
} else {
return G__83432;
}
})());
...
com.wsscode.pathom3.connect.foreign.internalize_foreign_indexes = (function com$wsscode$pathom3$connect$foreign$internalize_foreign_indexes(p__83439,foreign){
var map__83440 = p__83439;
var map__83440__$1 = cljs.core.__destructure_map(map__83440);
var indexes = map__83440__$1;
var index_source_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83440__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.indexes","index-source-id","com.wsscode.pathom3.connect.indexes/index-source-id",-190271180));
...
return com.wsscode.misc.coll.map_vals((function (p1__83438_SHARP_){
return com.wsscode.pathom3.connect.operation.update_config.cljs$core$IFn$_invoke$arity$4(p1__83438_SHARP_,cljs.core.assoc,new cljs.core.Keyword("com.wsscode.pathom3.connect.operation","dynamic-name","com.wsscode.pathom3.connect.operation/dynamic-name",1218566238),index_source_id__$1);
}),resolvers);
...
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(r__82170__auto__,(function (p__83452){
var map__83453 = p__83452;
var map__83453__$1 = cljs.core.__destructure_map(map__83453);
var indexes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83453__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.indexes","indexes","com.wsscode.pathom3.connect.indexes/indexes",-1732299100));
return com.wsscode.pathom3.connect.foreign.internalize_foreign_indexes(indexes,foreign);
}));
} else {
var map__83454 = r__82170__auto__;
var map__83454__$1 = cljs.core.__destructure_map(map__83454);
var indexes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83454__$1,new cljs.core.Keyword("com.wsscode.pathom3.connect.indexes","indexes","com.wsscode.pathom3.connect.indexes/indexes",-1732299100));
return com.wsscode.pathom3.connect.foreign.internalize_foreign_indexes(indexes,foreign);
}
});
