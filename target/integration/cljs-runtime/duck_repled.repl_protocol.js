...
var duck_repled$repl_protocol$Evaluator$_evaluate$dyn_84592 = (function (repl,command,options){
...
return duck_repled$repl_protocol$Evaluator$_evaluate$dyn_84592(repl,command,options);
}
});
...
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(result,(function (p1__84588_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([pass,p1__84588_SHARP_], 0));
}));
} else {
