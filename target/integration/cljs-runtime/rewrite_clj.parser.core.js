...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__57668 = cljs.core.get_global_hierarchy;
return (fexpr__57668.cljs$core$IFn$_invoke$arity$0 ? fexpr__57668.cljs$core$IFn$_invoke$arity$0() : fexpr__57668.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__57669_SHARP_){
var _STAR_delimiter_STAR__orig_val__57670 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__57671 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__57671);

try{return rewrite_clj.parser.core.parse_next(p1__57669_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__57670);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4835__auto__ = [];
var len__4829__auto___57694 = arguments.length;
var i__4830__auto___57695 = (0);
while(true){
if((i__4830__auto___57695 < len__4829__auto___57694)){
args__4835__auto__.push((arguments[i__4830__auto___57695]));

var G__57696 = (i__4830__auto___57695 + (1));
i__4830__auto___57695 = G__57696;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__57676){
var vec__57677 = p__57676;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57677,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq57672){
var G__57673 = cljs.core.first(seq57672);
var seq57672__$1 = cljs.core.next(seq57672);
var G__57674 = cljs.core.first(seq57672__$1);
var seq57672__$2 = cljs.core.next(seq57672__$1);
var G__57675 = cljs.core.first(seq57672__$2);
var seq57672__$3 = cljs.core.next(seq57672__$2);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57673,G__57674,G__57675,seq57672__$3);
}));
...
var G__57680 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57680)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__57680)){
...
return cljs.core.cons((function (){var G__57681 = rewrite_clj.reader.peek(reader);
switch (G__57681) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__57680)){
