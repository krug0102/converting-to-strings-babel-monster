...
var rewrite_clj$node$protocols$Node$tag$dyn_56538 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_56538(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_56539 = (function (node){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_56539(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_56544 = (function (node){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_56544(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_56546 = (function (node,opts){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_56546(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_56549 = (function (node){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_56549(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_56553 = (function (node){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_56553(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56514_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__56514_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_56564 = (function (node){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_56564(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_56566 = (function (node){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_56566(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_56570 = (function (node,children){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_56570(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_56571 = (function (node){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_56571(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_56574 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_56574(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_56579 = (function (node,map_qualifier){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_56579(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_56580 = (function (node){
var x__4521__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_56580(node);
}
});
...
var map__56527 = cljs.core.meta(node);
var map__56527__$1 = cljs.core.__destructure_map(map__56527);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56527__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56527__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56527__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56527__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__56528,p__56529){
var vec__56530 = p__56528;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56530,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56530,(1),null);
var vec__56533 = p__56529;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56533,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56533,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__56536 = col_extent;
if((row_extent === (0))){
return (G__56536 + col);
} else {
return G__56536;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__56537 = rewrite_clj.node.protocols.children(node);
var G__56537__$1 = (((G__56537 == null))?null:cljs.core.first(G__56537));
if((G__56537__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__56537__$1);
}
} else {
