...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66499_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.first(p1__66499_SHARP_),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"r","r",-471384190),cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.last(p1__66499_SHARP_)], 0))], 0));
...
var tag = cljs.core.first(hiccup_vector);
var render_function = (function (){var G__66529 = cljs.core.deref(repl_tooling.ui.pinkie.custom_renderers);
return (tag.cljs$core$IFn$_invoke$arity$1 ? tag.cljs$core$IFn$_invoke$arity$1(G__66529) : tag.call(null,G__66529));
})();
...
var style_vec = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66542_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__66542_SHARP_,/:/);
}),clojure.string.split.cljs$core$IFn$_invoke$arity$2(s,/;/));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4622__auto__ = (function repl_tooling$ui$pinkie$to_map_style_$_iter__66546(s__66547){
return (new cljs.core.LazySeq(null,(function (){
var s__66547__$1 = s__66547;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__66547__$1);
if(temp__5753__auto__){
var s__66547__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__66547__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__66547__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__66549 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__66548 = (0);
while(true){
if((i__66548 < size__4621__auto__)){
var vec__66554 = cljs.core._nth(c__4620__auto__,i__66548);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66554,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66554,(1),null);
cljs.core.chunk_append(b__66549,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.trim(k)),clojure.string.trim(v)], null));

var G__66611 = (i__66548 + (1));
i__66548 = G__66611;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__66549),repl_tooling$ui$pinkie$to_map_style_$_iter__66546(cljs.core.chunk_rest(s__66547__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__66549),null);
}
} else {
var vec__66559 = cljs.core.first(s__66547__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66559,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66559,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.trim(k)),clojure.string.trim(v)], null),repl_tooling$ui$pinkie$to_map_style_$_iter__66546(cljs.core.rest(s__66547__$2)));
}
} else {
return null;
}
