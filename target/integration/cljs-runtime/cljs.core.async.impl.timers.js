...
var i_37501 = (0);
while(true){
if((i_37501 < arr.length)){
(arr[i_37501] = null);

var G__37502 = (i_37501 + (1));
i_37501 = G__37502;
continue;
} else {
}
...
var i_37510 = (self__.level + (1));
while(true){
if((i_37510 <= (new_level + (1)))){
(update[i_37510] = self__.header);

var G__37514 = (i_37510 + (1));
i_37510 = G__37514;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_37515 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_37515[i]));
} else {
x__$2.forward.push((((i < links_37515.length))?(links_37515[i]):null));
}

if((i < links_37515.length)){
(links_37515[i] = x__$2);
} else {
links_37515.push(x__$2);
}
...
var i_37517 = (0);
while(true){
if((i_37517 <= self__.level)){
var links_37518 = (update[i_37517]).forward;
if((x__$1 === (((i_37517 < links_37518.length))?(links_37518[i_37517]):null))){
(links_37518[i_37517] = (x__$1.forward[i_37517]));

var G__37519 = (i_37517 + (1));
i_37517 = G__37519;
continue;
} else {
var G__37520 = (i_37517 + (1));
i_37517 = G__37520;
continue;
}
} else {
...
var G__37522 = nx;
var G__37523 = (level__$1 - (1));
x = G__37522;
level__$1 = G__37523;
continue;
} else {
var G__37524 = x;
var G__37525 = (level__$1 - (1));
x = G__37524;
level__$1 = G__37525;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__37527 = nx;
var G__37528 = (level__$1 - (1));
x = G__37527;
level__$1 = G__37528;
continue;
} else {
var G__37529 = x;
var G__37530 = (level__$1 - (1));
x = G__37529;
level__$1 = G__37530;
continue;
}
