...
var G__64313 = o;
goog.object.set(G__64313,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__65804.cljs$lang$applyTo = (function (arglist__65810){
...
var G__64418 = o;
goog.object.set(G__64418,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__64466 = props;
var G__64466__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64466,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__64466);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64466__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__64466__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__64498 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64498,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__64498;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__64563){
var map__64573 = p__64563;
var map__64573__$1 = cljs.core.__destructure_map(map__64573);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64573__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__64674_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__64674_SHARP_);
}));
} else {
return null;
}
...
var vec__65083 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65083,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65083,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65083,(2),null);
...
var temp__5757__auto___65852 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___65852 == null)){
} else {
var key_65853 = temp__5757__auto___65852;
(jsprops.key = key_65853);
}
...
var temp__5757__auto___65855 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___65855 == null)){
} else {
var key_65856 = temp__5757__auto___65855;
(jsprops.key = key_65856);
}
...
var G__65301 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__65301) : reagent.impl.template.as_element.call(null,G__65301));
} else {
var temp__5757__auto___65858 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___65858 == null)){
} else {
var key_65860 = temp__5757__auto___65858;
(jsprops.key = key_65860);
}
...
var G__65360 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__65360)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65360)){
return x;
} else {
...
var len__4829__auto___65861 = arguments.length;
var i__4830__auto___65862 = (0);
while(true){
if((i__4830__auto___65862 < len__4829__auto___65861)){
args__4835__auto__.push((arguments[i__4830__auto___65862]));

var G__65864 = (i__4830__auto___65862 + (1));
i__4830__auto___65862 = G__65864;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq65383){
var G__65385 = cljs.core.first(seq65383);
var seq65383__$1 = cljs.core.next(seq65383);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65385,seq65383__$1);
}));
...
break;
default:
var G__65881 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__65881;
continue;
...
var ctx = ({});
var vec__65631 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65631,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65631,(1),null);
...
var G__65691 = (cljs.core.count(argv) - first_child);
switch (G__65691) {
case (0):
