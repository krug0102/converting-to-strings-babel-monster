...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__44759){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__44766_SHARP_){
return (((p1__44766_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__44766_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__44774,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__44774;
}
});
...
var len__4829__auto___44821 = arguments.length;
var i__4830__auto___44822 = (0);
while(true){
if((i__4830__auto___44822 < len__4829__auto___44821)){
args__4835__auto__.push((arguments[i__4830__auto___44822]));

var G__44823 = (i__4830__auto___44822 + (1));
i__4830__auto___44822 = G__44823;
continue;
} else {
}
break;
...
var G__44781 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44781,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__44781;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq44775){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq44775));
}));
...
var vec__44786 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__44791 = cljs.core.ffirst(matches);
var fexpr__44790 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__44790.cljs$core$IFn$_invoke$arity$1 ? fexpr__44790.cljs$core$IFn$_invoke$arity$1(G__44791) : fexpr__44790.call(null,G__44791));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44786,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44786,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__44784_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__44784_SHARP_))){
return p1__44784_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__44785_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__44785_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__44811){
...
var tag = first__44814;
var content = seq__44813__$1;
...
var vec__44816 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44816,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44816,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44816,(2),null);
