...
var sym_seq = (function (){var iter__4622__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__57264(s__57265){
return (new cljs.core.LazySeq(null,(function (){
var s__57265__$1 = s__57265;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__57265__$1);
if(temp__5753__auto__){
var s__57265__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57265__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__57265__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__57267 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__57266 = (0);
while(true){
if((i__57266 < size__4621__auto__)){
var i = cljs.core._nth(c__4620__auto__,i__57266);
...
cljs.core.chunk_append(b__57267,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__57304 = (i__57266 + (1));
i__57266 = G__57304;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57267),rewrite_clj$node$fn$fn_walk_$_iter__57264(cljs.core.chunk_rest(s__57265__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57267),null);
}
} else {
var i = cljs.core.first(s__57265__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__57264(cljs.core.rest(s__57265__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__57261_SHARP_){
var or__4223__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__57261_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k57273,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57273,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__57279){
var vec__57280 = p__57279;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57280,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57280,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57272){
var self__ = this;
var G__57272__$1 = this;
return (new cljs.core.RecordIter((0),G__57272__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57274,other57275){
var self__ = this;
var this57274__$1 = this;
return (((!((other57275 == null)))) && ((((this57274__$1.constructor === other57275.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57274__$1.children,other57275.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57274__$1.__extmap,other57275.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k57273){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k57273);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__57272){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__57293 = cljs.core.keyword_identical_QMARK_;
var expr__57294 = k__4481__auto__;
if(cljs.core.truth_((pred__57293.cljs$core$IFn$_invoke$arity$2 ? pred__57293.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__57294) : pred__57293.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__57294)))){
return (new rewrite_clj.node.fn.FnNode(G__57272,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__57272),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__57272){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__57272,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__57276){
var extmap__4512__auto__ = (function (){var G__57303 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__57276,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__57276),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
