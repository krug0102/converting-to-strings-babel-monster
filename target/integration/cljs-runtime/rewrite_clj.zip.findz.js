...
var len__4829__auto___57817 = arguments.length;
var i__4830__auto___57818 = (0);
while(true){
if((i__4830__auto___57818 < len__4829__auto___57817)){
args__4835__auto__.push((arguments[i__4830__auto___57818]));

var G__57819 = (i__4830__auto___57818 + (1));
i__4830__auto___57818 = G__57819;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__57757){
var vec__57758 = p__57757;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57758,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__57749_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq57751){
var G__57752 = cljs.core.first(seq57751);
var seq57751__$1 = cljs.core.next(seq57751);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57752,seq57751__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__57762 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57762,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57762,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__57766 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__57769 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57766,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57769,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57769,(1),null);
var vec__57772 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57766,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57772,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57772,(1),null);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57782_SHARP_){
var and__4221__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__57782_SHARP_) : p_QMARK_.call(null,p1__57782_SHARP_));
if(cljs.core.truth_(and__4221__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__57782_SHARP_,pos);
} else {
return and__4221__auto__;
}
...
var G__57789 = zloc;
var G__57789__$1 = (((G__57789 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__57789) : f.call(null,G__57789)));
if((G__57789__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__57789__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__57790_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__57790_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__57800_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__57800_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__57810_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__57810_SHARP_),v);
}));
