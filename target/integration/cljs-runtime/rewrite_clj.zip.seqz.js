...
var G__57829 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__57829__$1 = (((G__57829 == null))?null:cljs.core.iterate((function (loc){
...
var G__57829__$2 = (((G__57829__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__57829__$1));
var G__57829__$3 = (((G__57829__$2 == null))?null:cljs.core.last(G__57829__$2));
if((G__57829__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__57829__$3);
}
} else {
return zloc;
}
...
var G__57841 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__57842 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__57841;
parent = G__57842;
continue;
} else {
var G__57843 = rewrite_clj.zip.move.right(zloc_map_value);
var G__57844 = parent;
loc = G__57843;
parent = G__57844;
continue;
...
var G__57845 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__57846 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__57845;
parent = G__57846;
continue;
} else {
var G__57847 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__57848 = parent;
loc = G__57847;
parent = G__57848;
continue;
...
var G__57830 = zloc;
var G__57830__$1 = (((G__57830 == null))?null:rewrite_clj.zip.move.down(G__57830));
var G__57830__$2 = (((G__57830__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__57830__$1,k));
if((G__57830__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__57830__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__57831 = zloc;
var G__57831__$1 = (((G__57831 == null))?null:rewrite_clj.zip.move.down(G__57831));
var G__57831__$2 = (((G__57831__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__57831__$1));
var G__57831__$3 = (((G__57831__$2 == null))?null:rewrite_clj.zip.move.down(G__57831__$2));
var G__57831__$4 = (((G__57831__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__57831__$3,k));
if((G__57831__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__57831__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__57834 = rewrite_clj.zip.move.down(zloc);
var G__57834__$1 = (((G__57834 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__57834));
if((G__57834__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__57834__$1);
}
})(),k);
