...
var G__47827 = cljs.core.first(e);
var G__47827__$1 = (((G__47827 instanceof cljs.core.Keyword))?G__47827.fqn:null);
switch (G__47827__$1) {
case "schema.spec.collection/optional":
var G__47829 = cljs.core.next(e);
var G__47830 = params;
var G__47831 = then;
return (schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3 ? schema.spec.collection.sequence_transformer.cljs$core$IFn$_invoke$arity$3(G__47829,G__47830,G__47831) : schema.spec.collection.sequence_transformer.call(null,G__47829,G__47830,G__47831));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47827__$1)].join('')));
...
return (function (res,x){
var G__47835 = res;
var G__47836 = (function (){var G__47837 = (function (t){
...
var G__47838 = x;
return (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(G__47837,G__47838) : parser.call(null,G__47837,G__47838));
})();
return (then.cljs$core$IFn$_invoke$arity$2 ? then.cljs$core$IFn$_invoke$arity$2(G__47835,G__47836) : then.call(null,G__47835,G__47836));
});
}
});
schema.spec.collection.sequence_transformer = (function schema$spec$collection$sequence_transformer(elts,params,then){
if(cljs.core.not_any_QMARK_((function (p1__47839_SHARP_){
return ((cljs.core.vector_QMARK_(p1__47839_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__47839_SHARP_),new cljs.core.Keyword("schema.spec.collection","remaining","schema.spec.collection/remaining",-421177821))));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k47845,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k47845,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__47857){
var vec__47858 = p__47857;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47858,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47858,(1),null);
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__47844){
var self__ = this;
var G__47844__$1 = this;
return (new cljs.core.RecordIter((0),G__47844__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this47846,other47847){
var self__ = this;
var this47846__$1 = this;
return (((!((other47847 == null)))) && ((((this47846__$1.constructor === other47847.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47846__$1.pre,other47847.pre)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47846__$1.constructor,other47847.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47846__$1.elements,other47847.elements)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47846__$1.on_error,other47847.on_error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47846__$1.__extmap,other47847.__extmap)))))))))))));
}));
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k47845){
var self__ = this;
var this__4479__auto____$1 = this;
var G__47871 = k47845;
var G__47871__$1 = (((G__47871 instanceof cljs.core.Keyword))?G__47871.fqn:null);
switch (G__47871__$1) {
case "pre":
case "constructor":
case "elements":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k47845);

}
}));

(schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__47844){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__47872 = cljs.core.keyword_identical_QMARK_;
var expr__47873 = k__4481__auto__;
if(cljs.core.truth_((pred__47872.cljs$core$IFn$_invoke$arity$2 ? pred__47872.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__47873) : pred__47872.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__47873)))){
return (new schema.spec.collection.CollectionSpec(G__47844,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47872.cljs$core$IFn$_invoke$arity$2 ? pred__47872.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"constructor","constructor",-1953928811),expr__47873) : pred__47872.call(null,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),expr__47873)))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__47844,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47872.cljs$core$IFn$_invoke$arity$2 ? pred__47872.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"elements","elements",657646735),expr__47873) : pred__47872.call(null,new cljs.core.Keyword(null,"elements","elements",657646735),expr__47873)))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__47844,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47872.cljs$core$IFn$_invoke$arity$2 ? pred__47872.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__47873) : pred__47872.call(null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__47873)))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__47844,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__47844),null));
}
}
}
}
...
(schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__47844){
var self__ = this;
var this__4471__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__47844,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__47850){
var extmap__4512__auto__ = (function (){var G__47878 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__47850,new cljs.core.Keyword(null,"pre","pre",2118456869),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)], 0));
if(cljs.core.record_QMARK_(G__47850)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__47878);
} else {
return G__47878;
}
})();
return (new schema.spec.collection.CollectionSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__47850),new cljs.core.Keyword(null,"constructor","constructor",-1953928811).cljs$core$IFn$_invoke$arity$1(G__47850),new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(G__47850),new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__47850),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var len__4829__auto___47963 = arguments.length;
var i__4830__auto___47964 = (0);
while(true){
if((i__4830__auto___47964 < len__4829__auto___47963)){
args__4835__auto__.push((arguments[i__4830__auto___47964]));

var G__47965 = (i__4830__auto___47964 + (1));
i__4830__auto___47964 = G__47965;
continue;
} else {
}
break;
...
/** @this {Function} */
(schema.spec.collection.optional.cljs$lang$applyTo = (function (seq47881){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47881));
}));
