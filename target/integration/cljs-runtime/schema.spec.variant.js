...
}catch (e47760){if((e47760 instanceof Object)){
var e_SHARP_ = e47760;
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k47766,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k47766,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__47772){
var vec__47774 = p__47772;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47774,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47774,(1),null);
...
var G__47782 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__47782) : self__.err_f.call(null,G__47782));
}),null)),null));
...
var or__4223__auto____$1 = (function (){var G__47784 = (cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__47784) : self__.post.call(null,G__47784));
})();
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this47767,other47768){
var self__ = this;
var this47767__$1 = this;
return (((!((other47768 == null)))) && ((((this47767__$1.constructor === other47768.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47767__$1.pre,other47768.pre)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47767__$1.options,other47768.options)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47767__$1.err_f,other47768.err_f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47767__$1.post,other47768.post)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47767__$1.__extmap,other47768.__extmap)))))))))))));
}));
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k47766){
var self__ = this;
var this__4479__auto____$1 = this;
var G__47787 = k47766;
var G__47787__$1 = (((G__47787 instanceof cljs.core.Keyword))?G__47787.fqn:null);
switch (G__47787__$1) {
case "pre":
case "options":
case "err-f":
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__47765){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__47788 = cljs.core.keyword_identical_QMARK_;
var expr__47789 = k__4481__auto__;
if(cljs.core.truth_((pred__47788.cljs$core$IFn$_invoke$arity$2 ? pred__47788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__47789) : pred__47788.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__47789)))){
return (new schema.spec.variant.VariantSpec(G__47765,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47788.cljs$core$IFn$_invoke$arity$2 ? pred__47788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"options","options",99638489),expr__47789) : pred__47788.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__47789)))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__47765,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47788.cljs$core$IFn$_invoke$arity$2 ? pred__47788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__47789) : pred__47788.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__47789)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__47765,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47788.cljs$core$IFn$_invoke$arity$2 ? pred__47788.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"post","post",269697687),expr__47789) : pred__47788.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__47789)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__47765,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__47765),null));
}
}
}
}
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__47765){
var self__ = this;
var this__4471__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__47765,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__47769){
var extmap__4512__auto__ = (function (){var G__47801 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__47769,new cljs.core.Keyword(null,"pre","pre",2118456869),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)], 0));
...
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__47769),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__47769),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__47769),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__47769),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
