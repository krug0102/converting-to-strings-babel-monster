...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__59091_SHARP_){
var G__59092 = rewrite_clj.custom_zipper.core.node(p1__59091_SHARP_);
if((!((G__59092 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__59092.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__59092.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__59092);
} else {
return false;
}
}
